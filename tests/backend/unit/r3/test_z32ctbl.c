...
static void test_z32ctbl_table_sizes_and_fingerprints(test_context *ctx) {
    ...
    assert_eq_u32(ctx, 2204738079u, fnv1a32(scdtblwk2, sizeof(scdtblwk2)),
                  "scdtblwk2 fnv1a32");
    assert_eq_u32(ctx, 1177667255u, fnv1a32(zone1scd, sizeof(zone1scd)),
                  "zone1scd fnv1a32");
    assert_eq_u32(ctx, 3998256129u, fnv1a32(mapwka, sizeof(mapwka)),
                  "mapwka fnv1a32");
    assert_eq_u32(ctx, 793237129u, fnv1a32(mapwkb, sizeof(mapwkb)),
                  "mapwkb fnv1a32");
}

static void test_z32ctbl_direction_and_collision_anchors(test_context *ctx) {
...
static void test_z32ctbl_map_anchors(test_context *ctx) {
    ...
    TEST_ASSERT_EQ_INT(ctx, 96, mapwka[1][1]);
    TEST_ASSERT_EQ_INT(ctx, 31, mapwka[2][11]);
    TEST_ASSERT_EQ_INT(ctx, 92, mapwka[3][9]);
    TEST_ASSERT_EQ_INT(ctx, 98, mapwka[4][10]);
    TEST_ASSERT_EQ_INT(ctx, 87, mapwka[5][15]);
    TEST_ASSERT_EQ_INT(ctx, 93, mapwka[5][34]);
...
TEST_MAIN_BEGIN;
test_z32ctbl_table_sizes_and_fingerprints(&ctx);
test_z32ctbl_direction_and_collision_anchors(&ctx);
test_z32ctbl_map_anchors(&ctx);
TEST_MAIN_END
