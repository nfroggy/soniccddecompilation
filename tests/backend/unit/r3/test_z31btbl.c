...
static void test_z31btbl_table_sizes_and_fingerprints(test_context *ctx) {
    ...
    assert_eq_u32(ctx, 2204738079u, fnv1a32(scdtblwk2, sizeof(scdtblwk2)),
                  "scdtblwk2 fnv1a32");
    assert_eq_u32(ctx, 1412568743u, fnv1a32(zone1scd, sizeof(zone1scd)),
                  "zone1scd fnv1a32");
    assert_eq_u32(ctx, 3753591401u, fnv1a32(mapwka, sizeof(mapwka)),
                  "mapwka fnv1a32");
    assert_eq_u32(ctx, 948988573u, fnv1a32(mapwkb, sizeof(mapwkb)),
                  "mapwkb fnv1a32");
}

static void test_z31btbl_direction_and_collision_anchors(test_context *ctx) {
...
static void test_z31btbl_map_anchors(test_context *ctx) {
    TEST_ASSERT_EQ_INT(ctx, 0, zone1scd[0]);
    TEST_ASSERT_EQ_INT(ctx, 81, zone1scd[2]);
    TEST_ASSERT_EQ_INT(ctx, 40, zone1scd[53]);
    TEST_ASSERT_EQ_INT(ctx, 81, zone1scd[135]);
    TEST_ASSERT_EQ_INT(ctx, 29, zone1scd[651]);
    TEST_ASSERT_EQ_INT(ctx, 0, zone1scd[999]);

    TEST_ASSERT_EQ_INT(ctx, 21, mapwka[0][10]);
    TEST_ASSERT_EQ_INT(ctx, 2, mapwka[0][14]);
    TEST_ASSERT_EQ_INT(ctx, 2, mapwka[1][16]);
    TEST_ASSERT_EQ_INT(ctx, 36, mapwka[2][2]);
    TEST_ASSERT_EQ_INT(ctx, 96, mapwka[3][0]);
    TEST_ASSERT_EQ_INT(ctx, 100, mapwka[5][24]);
    TEST_ASSERT_EQ_INT(ctx, 0, mapwka[7][63]);

    TEST_ASSERT_EQ_INT(ctx, 101, mapwkb[0][0]);
    TEST_ASSERT_EQ_INT(ctx, 104, mapwkb[0][1]);
    TEST_ASSERT_EQ_INT(ctx, 107, mapwkb[1][3]);
    TEST_ASSERT_EQ_INT(ctx, 102, mapwkb[2][6]);
    TEST_ASSERT_EQ_INT(ctx, 0, mapwkb[7][63]);
}

TEST_MAIN_BEGIN;
test_z31btbl_table_sizes_and_fingerprints(&ctx);
test_z31btbl_direction_and_collision_anchors(&ctx);
test_z31btbl_map_anchors(&ctx);
TEST_MAIN_END
