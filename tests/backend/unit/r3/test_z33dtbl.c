...
static void test_z33dtbl_table_sizes_and_fingerprints(test_context *ctx) {
    ...
    assert_eq_u32(ctx, 2204738079u, fnv1a32(scdtblwk2, sizeof(scdtblwk2)),
                  "scdtblwk2 fnv1a32");
    assert_eq_u32(ctx, 2419000318u, fnv1a32(zone1scd, sizeof(zone1scd)),
                  "zone1scd fnv1a32");
    assert_eq_u32(ctx, 577509955u, fnv1a32(mapwka, sizeof(mapwka)),
                  "mapwka fnv1a32");
    assert_eq_u32(ctx, 2361832501u, fnv1a32(mapwkb, sizeof(mapwkb)),
                  "mapwkb fnv1a32");
}

static void test_z33dtbl_direction_and_collision_anchors(test_context *ctx) {
...
static void test_z33dtbl_map_anchors(test_context *ctx) {
    TEST_ASSERT_EQ_INT(ctx, 0, zone1scd[0]);
    TEST_ASSERT_EQ_INT(ctx, 81, zone1scd[2]);
    TEST_ASSERT_EQ_INT(ctx, 64, zone1scd[20]);
    TEST_ASSERT_EQ_INT(ctx, 81, zone1scd[30]);
    TEST_ASSERT_EQ_INT(ctx, 40, zone1scd[53]);
    TEST_ASSERT_EQ_INT(ctx, 81, zone1scd[83]);
    TEST_ASSERT_EQ_INT(ctx, 0, zone1scd[999]);

    TEST_ASSERT_EQ_INT(ctx, 1, mapwka[0][0]);
    TEST_ASSERT_EQ_INT(ctx, 6, mapwka[0][5]);
    TEST_ASSERT_EQ_INT(ctx, 7, mapwka[1][0]);
    TEST_ASSERT_EQ_INT(ctx, 29, mapwka[1][5]);
    TEST_ASSERT_EQ_INT(ctx, 12, mapwka[2][0]);
    TEST_ASSERT_EQ_INT(ctx, 16, mapwka[2][4]);
    TEST_ASSERT_EQ_INT(ctx, 17, mapwka[3][1]);
    TEST_ASSERT_EQ_INT(ctx, 20, mapwka[3][4]);
    TEST_ASSERT_EQ_INT(ctx, 31, mapwka[4][0]);
    TEST_ASSERT_EQ_INT(ctx, 12, mapwka[4][5]);
    TEST_ASSERT_EQ_INT(ctx, 30, mapwka[5][1]);
    TEST_ASSERT_EQ_INT(ctx, 28, mapwka[5][5]);
    TEST_ASSERT_EQ_INT(ctx, 0, mapwka[7][63]);

    TEST_ASSERT_EQ_INT(ctx, 104, mapwkb[0][0]);
    TEST_ASSERT_EQ_INT(ctx, 104, mapwkb[0][2]);
    TEST_ASSERT_EQ_INT(ctx, 102, mapwkb[1][0]);
    TEST_ASSERT_EQ_INT(ctx, 102, mapwkb[1][2]);
    TEST_ASSERT_EQ_INT(ctx, 103, mapwkb[2][0]);
    TEST_ASSERT_EQ_INT(ctx, 105, mapwkb[2][1]);
    TEST_ASSERT_EQ_INT(ctx, 106, mapwkb[2][2]);
    TEST_ASSERT_EQ_INT(ctx, 0, mapwkb[7][63]);
}

TEST_MAIN_BEGIN;
test_z33dtbl_table_sizes_and_fingerprints(&ctx);
test_z33dtbl_direction_and_collision_anchors(&ctx);
test_z33dtbl_map_anchors(&ctx);
TEST_MAIN_END
