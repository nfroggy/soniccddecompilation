...
#include "src/r5/col5a.c"

static void reset_col5a_state(void) {
...
static void test_col5a_tables_capture_palette_contract(test_context *ctx) {
    ...
    assert_palette(ctx, zone5color0[47], 32, 0, 0, 1, "zone5color0[47]");
    assert_palette(ctx, zone5color1[47], 192, 128, 32, 1,
                   "zone5color1[47]");
...
static void test_clchgctr_updates_normal_reverse_and_enkei_cycles(
    test_context *ctx) {
    reset_col5a_state();
    ...
    assert_palette(ctx, colorwk[42], 64, 32, 128, 1, "normal color 42");
    assert_palette(ctx, colorwk[43], 128, 96, 160, 1, "normal color 43");
    assert_palette(ctx, colorwk[44], 192, 160, 224, 1, "normal color 44");
    assert_palette(ctx, colorwk[58], 32, 160, 224, 1, "normal color 58");
    assert_palette(ctx, colorwk[62], 32, 0, 64, 1, "normal color 62");
    ...
    assert_palette(ctx, colorwk[42], 224, 224, 0, 1, "reverse color 42");
    assert_palette(ctx, colorwk[43], 64, 0, 0, 1, "reverse color 43");
    assert_palette(ctx, colorwk[44], 192, 96, 0, 1, "reverse color 44");
    ...
    assert_palette(ctx, colorwk[56], 0, 160, 224, 1, "enkei color 56");
    assert_palette(ctx, colorwk[57], 0, 0, 160, 1, "enkei color 57");
    assert_palette(ctx, colorwk[58], 0, 64, 224, 1, "enkei color 58");
}
...
static void test_colorset_routes_to_palette_work_buffers(test_context *ctx) {
    ...
    assert_palette(ctx, colorwk[63], 32, 0, 0, 1, "colorset2 work 0 end");

    colorset3(5);
    assert_palette(ctx, colorwk2[16], 0, 0, 0, 1, "colorset3 work 1");
    assert_palette(ctx, colorwk2[63], 192, 128, 32, 1,
...
TEST_MAIN_BEGIN;
    test_col5a_tables_capture_palette_contract(&ctx);
    test_colchgsub_waits_updates_and_wraps(&ctx);
    test_clchgctr_updates_normal_reverse_and_enkei_cycles(&ctx);
