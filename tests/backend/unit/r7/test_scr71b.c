...
static void reset_scr71b_state(void) {
...
static void test_scr71b_scr_set_and_play_position_defaults(test_context *ctx) {
    reset_scr71b_state();
...
static void test_scr71b_playposiset_loads_and_clamps_saved_position(
    test_context *ctx) {
    reset_scr71b_state();
    plflag = 1;
    scralim_right = 500;
...
static void test_scr71b_horizontal_scroll_clamps_and_sets_speed(
    test_context *ctx) {
    reset_scr71b_state();
    scralim_right = 1000;
    scralim_left = 100;
...
static void test_scr71b_scroll_h_flags_direction_changes(test_context *ctx) {
    reset_scr71b_state();
    scralim_right = 1000;
    scralim_left = 0;
    scra_hline = 160;
...
static void test_scr71b_vertical_scroll_paths_and_clamps(test_context *ctx) {
    int_union pos;
...
static void test_scr71b_parallax_scroll_flags_and_values(test_context *ctx) {
    int_union dx;
    int_union dy;
...
static void test_scr71b_hscroll_line_builders_and_zone_copy(test_context *ctx) {
    Sint32 count;
    ...
    count = z71aline(0);
    TEST_ASSERT_EQ_INT(ctx, 44, count);
    TEST_ASSERT_EQ_INT(ctx, -98, hscrollwork[0]);

    count = z71aline0(count);
    TEST_ASSERT_EQ_INT(ctx, 52, count);
    TEST_ASSERT_EQ_INT(ctx, -40, hscrollwork[44]);
    ...
    waterdirec.b.h = 7;
    scrz_h_posit.w.h = 30;
    zonescrsetsub0(616, 0);

    TEST_ASSERT_EQ_INT(ctx, 240, sinset_count);
    TEST_ASSERT_EQ_INT(ctx, 229, sinset_angle);
    TEST_ASSERT_EQ_INT(ctx, -35, hscroll_buffer[8].w.l);
}

static void test_scr71b_block_write_and_mapinit(test_context *ctx) {
    POINT tile;
...
static void test_scr71b_map_address_and_vram_helpers(test_context *ctx) {
    Sint32 index;
    Uint16 *block_ptr;
    POINT tile;
...
static void test_scr71b_blockwrt_flip_orders(test_context *ctx) {
    POINT tile;
...
static void test_scr71b_scroll_wrapper_and_pose_vertical_branches(
    test_context *ctx) {
    reset_scr71b_state();
    scroll_start.b.h = 1;
...
static void test_scr71b_scroll_write_helpers_touch_grid(test_context *ctx) {
    POINT tile;
...
static void test_scr71b_additional_scroll_edges(test_context *ctx) {
    int_union delta;
...
static void test_scr71b_additional_vertical_speed_selectors(test_context *ctx) {
    reset_scr71b_state();
    scralim_down = 1296;
    scra_vline = 96;
    scra_v_posit.w.h = 100;
...
static void test_scr71b_negative_parallax_flags(test_context *ctx) {
    int_union dx;
    int_union dy;
...
static void test_scr71b_map_block_edges_and_noops(test_context *ctx) {
    Sint32 index;
    Uint16 *block_ptr;
    POINT tile;
...
static void test_scr71b_map_writer_smoke_paths(test_context *ctx) {
    Uint8 flag;
    Uint8 wrt_tbl[1] = {2};
...
static void test_scr71b_scrollwrt_foreground_flag_paths(test_context *ctx) {
    reset_scr71b_state();
    blockwk[0][0] = 61;
    blockwk[0][1] = 62;
    blockwk[0][2] = 63;
...
static void test_scr71b_block_write_visible_and_vertical_wrap(
    test_context *ctx) {
    POINT tile;
...
TEST_MAIN_BEGIN;
    test_scr71b_scr_set_and_play_position_defaults(&ctx);
    test_scr71b_playposiset_loads_and_clamps_saved_position(&ctx);
    test_scr71b_horizontal_scroll_clamps_and_sets_speed(&ctx);
    test_scr71b_scroll_h_flags_direction_changes(&ctx);
    test_scr71b_vertical_scroll_paths_and_clamps(&ctx);
    test_scr71b_parallax_scroll_flags_and_values(&ctx);
    test_scr71b_hscroll_line_builders_and_zone_copy(&ctx);
    test_scr71b_block_write_and_mapinit(&ctx);
    test_scr71b_map_address_and_vram_helpers(&ctx);
    test_scr71b_blockwrt_flip_orders(&ctx);
    test_scr71b_scroll_wrapper_and_pose_vertical_branches(&ctx);
    test_scr71b_scroll_write_helpers_touch_grid(&ctx);
    test_scr71b_additional_scroll_edges(&ctx);
    test_scr71b_additional_vertical_speed_selectors(&ctx);
    test_scr71b_negative_parallax_flags(&ctx);
    test_scr71b_map_block_edges_and_noops(&ctx);
    test_scr71b_map_writer_smoke_paths(&ctx);
    test_scr71b_scrollwrt_foreground_flag_paths(&ctx);
    test_scr71b_block_write_visible_and_vertical_wrap(&ctx);
TEST_MAIN_END;
