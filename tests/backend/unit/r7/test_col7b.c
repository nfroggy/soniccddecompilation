...
#include "src/r7/col7b.c"

static void reset_col7b_state(void) {
...
static void test_col7b_tables_capture_literal_palette_data(test_context *ctx) {
    ...
    assert_palette(ctx, advacolor[33], 128, 224, 160, 1, "advacolor[33]");
    assert_palette(ctx, advacolor[47], 224, 0, 0, 1, "advacolor[47]");
    assert_palette(ctx, advacolor[63], 224, 224, 0, 1, "advacolor[63]");
    assert_palette(ctx, zone82colora[17], 128, 224, 160, 1,
                   "zone82colora[17]");
    assert_palette(ctx, zone82colora[31], 224, 0, 0, 1,
                   "zone82colora[31]");
    assert_palette(ctx, zone82colora[47], 224, 224, 0, 1,
                   "zone82colora[47]");

    TEST_ASSERT_TRUE(ctx, colortbl[0].PeSrc == advacolor);
    TEST_ASSERT_TRUE(ctx, colortbl[1].PeSrc == advacolor);
    TEST_ASSERT_TRUE(ctx, colortbl[2].PeSrc == advacolor);
    TEST_ASSERT_TRUE(ctx, colortbl[3].PeSrc == advacolor);
    TEST_ASSERT_TRUE(ctx, colortbl[4].PeSrc == &advacolor[16]);
    TEST_ASSERT_TRUE(ctx, colortbl[5].PeSrc == zone82colora);
    TEST_ASSERT_EQ_INT(ctx, 0, colortbl[3].offset);
...
static void test_colorset_routes_to_all_palette_work_buffers(test_context *ctx) {
    ...
    assert_palette(ctx, colorwk3[63], 224, 224, 0, 1,
                   "colorset4 work 2 end");

    colorset00(0, 3);
    assert_palette(ctx, colorwk4[0], 0, 0, 0, 1, "colorset00 default");
    assert_palette(ctx, colorwk4[63], 224, 224, 0, 1,
...
TEST_MAIN_BEGIN;
test_col7b_tables_capture_literal_palette_data(&ctx);
