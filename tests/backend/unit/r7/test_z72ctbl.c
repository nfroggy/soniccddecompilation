...
static void test_z72ctbl_table_sizes_and_fingerprints(test_context *ctx) {
    ...
    assert_eq_u32(ctx, 2204738079u, fnv1a32(scdtblwk2, sizeof(scdtblwk2)),
                  "scdtblwk2 fnv1a32");
    assert_eq_u32(ctx, 1655214980u, fnv1a32(zone1scd, sizeof(zone1scd)),
                  "zone1scd fnv1a32");
    assert_eq_u32(ctx, 2496491795u, fnv1a32(mapwka, sizeof(mapwka)),
                  "mapwka fnv1a32");
    assert_eq_u32(ctx, 2059497974u, fnv1a32(mapwkb, sizeof(mapwkb)),
                  "mapwkb fnv1a32");
}

static void test_z72ctbl_direction_and_collision_anchors(test_context *ctx) {
...
static void test_z72ctbl_map_anchors(test_context *ctx) {
    TEST_ASSERT_EQ_INT(ctx, 0, zone1scd[0]);
    TEST_ASSERT_EQ_INT(ctx, 81, zone1scd[1]);
    TEST_ASSERT_EQ_INT(ctx, 88, zone1scd[3]);
    TEST_ASSERT_EQ_INT(ctx, 106, zone1scd[46]);
    TEST_ASSERT_EQ_INT(ctx, 0, zone1scd[999]);

    TEST_ASSERT_EQ_INT(ctx, 3, mapwka[0][0]);
    TEST_ASSERT_EQ_INT(ctx, 31, mapwka[0][1]);
    TEST_ASSERT_EQ_INT(ctx, 129, mapwka[0][29]);
    TEST_ASSERT_EQ_INT(ctx, 152, mapwka[1][2]);
    TEST_ASSERT_EQ_INT(ctx, 160, mapwka[2][0]);
    ...
    TEST_ASSERT_EQ_INT(ctx, 107, mapwkb[1][1]);
    TEST_ASSERT_EQ_INT(ctx, 112, mapwkb[2][0]);
    TEST_ASSERT_EQ_INT(ctx, 113, mapwkb[2][1]);
    TEST_ASSERT_EQ_INT(ctx, 0, mapwkb[7][63]);
}

TEST_MAIN_BEGIN;
    test_z72ctbl_table_sizes_and_fingerprints(&ctx);
    test_z72ctbl_direction_and_collision_anchors(&ctx);
    test_z72ctbl_map_anchors(&ctx);
TEST_MAIN_END
