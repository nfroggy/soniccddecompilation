...
static void test_coli7_tables_capture_literal_data(test_context *ctx) {
    ...
    TEST_ASSERT_EQ_INT(ctx, 0, colitbl[62][0]);
    TEST_ASSERT_EQ_INT(ctx, 0, colitbl[62][1]);
...
TEST_MAIN_BEGIN;
test_coli7_tables_capture_literal_data(&ctx);
