...
static void reset_scr72d_state(void) {
...
static void test_scr72d_scr_set_and_saved_position(test_context *ctx) {
    reset_scr72d_state();
...
static void test_scr72d_horizontal_and_vertical_scroll(test_context *ctx) {
    int_union pos;
...
static void test_scr72d_parallax_and_hscroll_lines(test_context *ctx) {
    int_union dx;
    int_union dy;
    Sint32 count;
...
static void test_scr72d_map_and_block_helpers(test_context *ctx) {
    Sint32 index;
    Uint16 *block_ptr;
    POINT tile;
...
static void test_scr72d_scroll_write_and_mapinit(test_context *ctx) {
    Uint8 flag;
...
static void test_scr72d_scroll_h_flags_direction_changes(test_context *ctx) {
    reset_scr72d_state();
    scralim_right = 1000;
    scralim_left = 0;
    scra_hline = 160;
...
static void test_scr72d_scroll_edge_clamps_and_wraps(test_context *ctx) {
    int_union pos;
...
static void test_scr72d_parallax_scroll_flags_and_negative_paths(
    test_context *ctx) {
    int_union dx;
    int_union dy;
...
static void test_scr72d_scroll_wrapper_and_pose_vertical_branches(
    test_context *ctx) {
    reset_scr72d_state();
    scroll_start.b.h = 1;
...
static void test_scr72d_additional_vertical_speed_selectors(test_context *ctx) {
    reset_scr72d_state();
    scralim_down = 1296;
    scra_vline = 96;
    scra_v_posit.w.h = 100;
...
static void test_scr72d_additional_scroll_edges(test_context *ctx) {
    int_union delta;
...
static void test_scr72d_blockwrt_flip_orders(test_context *ctx) {
    POINT tile;
...
static void test_scr72d_map_block_edges_and_noops(test_context *ctx) {
    Sint32 index;
    Uint16 *block_ptr;
    POINT tile;
...
static void test_scr72d_scroll_write_helpers_touch_grid(test_context *ctx) {
    POINT tile;
...
static void test_scr72d_map_writer_smoke_paths(test_context *ctx) {
    Uint8 flag;
...
static void test_scr72d_scrollwrt_foreground_flag_paths(test_context *ctx) {
    reset_scr72d_state();
    blockwk[0][0] = 61;
    blockwk[0][1] = 62;
    blockwk[0][2] = 63;
...
static void test_scr72d_block_write_visible_and_vertical_wrap(
    test_context *ctx) {
    POINT tile;
...
TEST_MAIN_BEGIN;
    test_scr72d_scr_set_and_saved_position(&ctx);
    test_scr72d_horizontal_and_vertical_scroll(&ctx);
    test_scr72d_parallax_and_hscroll_lines(&ctx);
    test_scr72d_map_and_block_helpers(&ctx);
    test_scr72d_scroll_write_and_mapinit(&ctx);
    test_scr72d_scroll_h_flags_direction_changes(&ctx);
    test_scr72d_scroll_edge_clamps_and_wraps(&ctx);
    test_scr72d_parallax_scroll_flags_and_negative_paths(&ctx);
    test_scr72d_scroll_wrapper_and_pose_vertical_branches(&ctx);
    test_scr72d_additional_vertical_speed_selectors(&ctx);
    test_scr72d_additional_scroll_edges(&ctx);
    test_scr72d_blockwrt_flip_orders(&ctx);
    test_scr72d_map_block_edges_and_noops(&ctx);
    test_scr72d_scroll_write_helpers_touch_grid(&ctx);
    test_scr72d_map_writer_smoke_paths(&ctx);
    test_scr72d_scrollwrt_foreground_flag_paths(&ctx);
    test_scr72d_block_write_visible_and_vertical_wrap(&ctx);
TEST_MAIN_END;
