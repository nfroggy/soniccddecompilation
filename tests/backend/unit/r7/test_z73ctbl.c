...
static void test_z73ctbl_table_sizes_and_fingerprints(test_context *ctx) {
    ...
    assert_eq_u32(ctx, 2204738079u, fnv1a32(scdtblwk2, sizeof(scdtblwk2)),
                  "scdtblwk2 fnv1a32");
    assert_eq_u32(ctx, 263329542u, fnv1a32(zone1scd, sizeof(zone1scd)),
                  "zone1scd fnv1a32");
    assert_eq_u32(ctx, 2369398404u, fnv1a32(mapwka, sizeof(mapwka)),
                  "mapwka fnv1a32");
    assert_eq_u32(ctx, 2059497974u, fnv1a32(mapwkb, sizeof(mapwkb)),
                  "mapwkb fnv1a32");
}

static void test_z73ctbl_direction_and_collision_anchors(test_context *ctx) {
...
static void test_z73ctbl_map_anchors(test_context *ctx) {
    TEST_ASSERT_EQ_INT(ctx, 0, zone1scd[0]);
    TEST_ASSERT_EQ_INT(ctx, 81, zone1scd[1]);
    TEST_ASSERT_EQ_INT(ctx, 88, zone1scd[3]);
    TEST_ASSERT_EQ_INT(ctx, 0, zone1scd[96]);
    TEST_ASSERT_EQ_INT(ctx, 0, zone1scd[999]);

    TEST_ASSERT_EQ_INT(ctx, 129, mapwka[0][0]);
    TEST_ASSERT_EQ_INT(ctx, 129, mapwka[0][63]);
    TEST_ASSERT_EQ_INT(ctx, 2, mapwka[1][0]);
    TEST_ASSERT_EQ_INT(ctx, 58, mapwka[1][6]);
    TEST_ASSERT_EQ_INT(ctx, 27, mapwka[2][20]);
...
TEST_MAIN_BEGIN;
    test_z73ctbl_table_sizes_and_fingerprints(&ctx);
    test_z73ctbl_direction_and_collision_anchors(&ctx);
    test_z73ctbl_map_anchors(&ctx);
TEST_MAIN_END
