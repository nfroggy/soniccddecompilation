...
static void assert_one_sprite_pattern(test_context *ctx,
...
static void test_dango8_tables_capture_literal_data(test_context *ctx) {
    ...
    assert_one_sprite_pattern(ctx, &spr_dango_e_00, -16, -12, 0, 466);
    TEST_ASSERT_EQ_INT(ctx, 2, spr_dango_e_02.cnt);
    TEST_ASSERT_EQ_INT(ctx, -5, spr_dango_e_02.spra[0].xoff);
    TEST_ASSERT_EQ_INT(ctx, -12, spr_dango_e_02.spra[0].yoff);
    TEST_ASSERT_EQ_INT(ctx, 471, spr_dango_e_02.spra[0].index);
    TEST_ASSERT_EQ_INT(ctx, -16, spr_dango_e_02.spra[1].xoff);
    TEST_ASSERT_EQ_INT(ctx, -16, spr_dango_e_02.spra[1].yoff);
    TEST_ASSERT_EQ_INT(ctx, 474, spr_dango_e_02.spra[1].index);
    assert_one_sprite_pattern(ctx, &spr_dango_e_05, -16, -15, 0, 473);
    assert_one_sprite_pattern(ctx, &spr_dango_b_00, -16, -12, 0, 468);
    assert_one_sprite_pattern(ctx, &spr_dango_b_02, -16, -17, 0, 470);
    TEST_ASSERT_EQ_INT(ctx, 2, spr_dango_b_03.cnt);
    TEST_ASSERT_EQ_INT(ctx, -4, spr_dango_b_03.spra[0].xoff);
    TEST_ASSERT_EQ_INT(ctx, 471, spr_dango_b_03.spra[0].index);
    TEST_ASSERT_EQ_INT(ctx, 474, spr_dango_b_03.spra[1].index);
}

static void test_dango8_suicide_short_circuits(test_context *ctx) {
...
static void test_dango8_initializes_green_and_brown_variants(test_context *ctx) {
    sprite_status *actor = &actwk[4];
    ...
    TEST_ASSERT_EQ_INT(ctx, 14, actor->sprhs);
    TEST_ASSERT_EQ_INT(ctx, 14, actor->sprhsize);
    TEST_ASSERT_EQ_INT(ctx, 9, actor->sprvsize);
...
static void test_dango8_transition_helpers_capture_exact_state(
    ...
    TEST_ASSERT_EQ_INT(ctx, 44, actor->yposi.w.h);
    ...
    actor->colino = 237;
    a_to_walk(actor);
    TEST_ASSERT_EQ_INT(ctx, 26, actor->r_no0);
    TEST_ASSERT_EQ_INT(ctx, 6, actor->mstno.b.h);
    TEST_ASSERT_EQ_INT(ctx, 47, actor->yposi.w.h);
    TEST_ASSERT_EQ_INT(ctx, 16, actor->sprvsize);
    TEST_ASSERT_EQ_INT(ctx, 44, actor->colino);
...
static void test_dango8_move_reverses_when_wall_blocks(test_context *ctx) {
    sprite_status *actor = &actwk[4];
...
static void test_dango8_walk1_detects_player_side_and_green_patch(
    test_context *ctx) {
    sprite_status *actor = &actwk[4];
...
static void test_dango8_move_restores_x_when_floor_is_out_of_range(
    test_context *ctx) {
    sprite_status *actor = &actwk[4];
    Sint16 moved;
    ...
    TEST_ASSERT_EQ_INT(ctx, 20, actor->xposi.w.h);
    TEST_ASSERT_EQ_INT(ctx, 1, emycol_r_count);
    TEST_ASSERT_EQ_INT(ctx, 1, emycol_d_count);
}

static void test_dango8_move_patchg_and_roll_collision_paths(
    test_context *ctx) {
    sprite_status *actor = &actwk[4];
...
static void test_dango8_roll1_no_collision_moves_or_advances_state(
    test_context *ctx) {
    sprite_status *actor = &actwk[4];
...
TEST_MAIN_BEGIN;
    test_dango8_tables_capture_literal_data(&ctx);
    test_dango8_suicide_short_circuits(&ctx);
    test_dango8_initializes_green_and_brown_variants(&ctx);
    test_dango8_fall_walk_and_roll_setup_paths(&ctx);
    test_dango8_transition_helpers_capture_exact_state(&ctx);
    test_dango8_move_reverses_when_wall_blocks(&ctx);
    test_dango8_walk1_detects_player_side_and_green_patch(&ctx);
    test_dango8_move_restores_x_when_floor_is_out_of_range(&ctx);
    test_dango8_move_patchg_and_roll_collision_paths(&ctx);
    test_dango8_roll1_no_collision_moves_or_advances_state(&ctx);
TEST_MAIN_END
