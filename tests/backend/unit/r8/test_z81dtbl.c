...
static void test_z81dtbl_table_sizes_and_fingerprints(test_context *ctx) {
    ...
    assert_eq_u32(ctx, 2204738079u, fnv1a32(scdtblwk2, sizeof(scdtblwk2)),
                  "scdtblwk2 fnv1a32");
    assert_eq_u32(ctx, 603607584u, fnv1a32(zone1scd, sizeof(zone1scd)),
                  "zone1scd fnv1a32");
...
static void test_z81dtbl_direction_and_collision_anchors(test_context *ctx) {
...
static void test_z81dtbl_map_anchors(test_context *ctx) {
...
TEST_MAIN_BEGIN;
    test_z81dtbl_table_sizes_and_fingerprints(&ctx);
    test_z81dtbl_direction_and_collision_anchors(&ctx);
    test_z81dtbl_map_anchors(&ctx);
TEST_MAIN_END
