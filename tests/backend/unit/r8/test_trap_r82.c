...
static void test_gater8_frames_out_immediately(test_context *ctx) {
...
static void test_harir8_low_negative_userflag_damages_player(
    test_context *ctx) {
    sprite_status *spike = &actwk[5];
...
static void test_harir8_medium_negative_priority_zero_checks_collision(
    test_context *ctx) {
    sprite_status *spike = &actwk[5];
...
static void test_harir8_medium_negative_priority_one_clears_ride(
    test_context *ctx) {
    sprite_status *spike = &actwk[5];
    ...
    TEST_ASSERT_TRUE(ctx, ride_on_clr_actor == spike);
}

static void test_harir8_high_negative_priority_zero_clears_ride(
    test_context *ctx) {
    sprite_status *spike = &actwk[5];
...
static void test_harir8_high_negative_priority_one_checks_collision(
    test_context *ctx) {
    sprite_status *spike = &actwk[5];
...
static void test_togedair8_special_userflag_runs_tokusyu_block(
    test_context *ctx) {
    sprite_status *block = &actwk[3];

    reset_trap_state();
    block->actno = 54;
    block->userflag.b.h = -8;
    prio_flag = 0;
...
static void test_tokusyu_block_priority_one_checks_ride(test_context *ctx) {
    sprite_status *block = &actwk[3];
...
TEST_MAIN_BEGIN;
    test_gater8_frames_out_immediately(&ctx);
    ...
    test_harir8_low_negative_userflag_damages_player(&ctx);
    ...
    test_harir8_medium_negative_priority_zero_checks_collision(&ctx);
    test_harir8_medium_negative_priority_one_clears_ride(&ctx);
    test_harir8_high_negative_priority_zero_clears_ride(&ctx);
    test_harir8_high_negative_priority_one_checks_collision(&ctx);
