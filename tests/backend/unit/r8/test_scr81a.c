...
static void reset_scr81a_state(void) {
...
static void test_scr81a_main_chk_selects_active_player(test_context *ctx) {
    reset_scr81a_state();
    main_play = 0;
...
static void test_scr81a_scr_set_uses_default_start_and_parallax(
    test_context *ctx) {
    reset_scr81a_state();
...
static void test_scr81a_scr_set_loads_saved_position_when_plflag_is_set(
    test_context *ctx) {
    reset_scr81a_state();
    plflag = 1;
...
static void test_scr81a_scr_set_saved_position_clamps_to_scroll_limits(
    test_context *ctx) {
    reset_scr81a_state();
    plflag = 1;
    ...
    TEST_ASSERT_EQ_INT(ctx, 452, scrb_v_posit.w.h);
}

static void test_scr81a_scr_set_uses_end_demo_position(test_context *ctx) {
    reset_scr81a_state();
    demoflag.w = -32768;
    enddemono = 2;
    ...
    TEST_ASSERT_EQ_INT(ctx, 259, scrb_v_posit.w.h);
}

static void test_scr81a_mapadrset_empty_and_populated_screens(
    test_context *ctx) {
    Sint32 index = 123;
...
static void test_scr81a_mapadrset_clamps_high_offsets(test_context *ctx) {
    Sint32 index = 0;
...
static void test_scr81a_mapadrset2_reports_block_pointer_and_empty_screen(
    test_context *ctx) {
    Sint32 index = 123;
...
static void test_scr81a_vram_address_masks_to_tile_grid(test_context *ctx) {
    POINT tile = {0, 0};
...
static void test_scr81a_blockwrt_emits_unflipped_and_flipped_quads(
    test_context *ctx) {
    POINT tile = {4, 6};
...
static void test_scr81a_blockwrt_emits_single_axis_flips(test_context *ctx) {
    POINT tile = {8, 10};
...
static void test_scr81a_scroll_respects_start_guard(test_context *ctx) {
    reset_scr81a_state();
    scroll_start.b.h = 1;
    scrflaga.w = 0x1234;
...
static void test_scr81a_scroll_moves_right_and_builds_hscroll(
    test_context *ctx) {
    reset_scr81a_state();
    scr_set();
    ...
    TEST_ASSERT_EQ_INT(ctx, 400, scrb_v_posit.w.h);
    TEST_ASSERT_EQ_INT(ctx, 400, vscroll.w.l);
    TEST_ASSERT_EQ_INT(ctx, -16, hscroll_buffer[0].w.h);
}

static void test_scr81a_scroll_moves_left_and_flags_horizontal_edge(
    test_context *ctx) {
    reset_scr81a_state();
    scralim_left = 0;
    scralim_right = 7831;
...
static void test_scr81a_scroll_h_exact_center_and_left_limit(test_context *ctx) {
    reset_scr81a_state();
    scralim_left = 0;
    scralim_right = 7831;
    scra_hline = 160;
...
static void test_scr81a_scroll_h_clamps_to_right_limit(test_context *ctx) {
    reset_scr81a_state();
    scralim_left = 0;
    scralim_right = 120;
    scra_hline = 160;
...
static void test_scr81a_scroll_negative_parallax_flags(test_context *ctx) {
    reset_scr81a_state();
    scralim_left = 0;
    scralim_right = 7831;
    scralim_up = 0;
...
static void test_scr81a_scrollb_v_flags_up_and_down_edges(test_context *ctx) {
    reset_scr81a_state();
    scrb_v_posit.w.h = 32;
    scrb_v_count = 16;
...
static void test_scr81a_vertical_move_paths_and_limits(test_context *ctx) {
    reset_scr81a_state();
    scralim_up = 0;
    scralim_down = 1808;
    scra_vline = 96;
...
static void test_scr81a_vertical_edge_branches(test_context *ctx) {
    reset_scr81a_state();
    scralim_up = 0;
    scralim_down = 1808;
    scra_vline = 96;
...
static void test_scr81a_direct_vertical_helpers_cover_small_moves(
    test_context *ctx) {
    int_union lSpd;
...
static void test_scr81a_vertical_special_posture_paths(test_context *ctx) {
    reset_scr81a_state();
    scralim_up = 0;
    scralim_down = 1808;
    scra_vline = 96;
...
static void test_scr81a_scroll_wraps_vertical_edges(test_context *ctx) {
    int_union lSpd;
...
static void test_scr81a_scrollwrt_processes_all_screen_flags(
    test_context *ctx) {
    reset_scr81a_state();
...
static void test_scr81a_scrollwrtb_bit2_and_empty_paths(test_context *ctx) {
    Uint8 flag;

    reset_scr81a_state();
    seed_screen_zero((Uint8 *)mapwkb);
    scrb_v_posit.w.h = 144;
    flag = 1;
...
static void test_scr81a_mapwrt_and_block_wrt_emit_grid_updates(
    test_context *ctx) {
    reset_scr81a_state();
    seed_screen_zero((Uint8 *)mapwka);
    seed_screen_zero((Uint8 *)mapwkb);
...
static void test_scr81a_block_wrt_visible_region_emits_grid_update(
    test_context *ctx) {
    reset_scr81a_state();
    mapwka[0][0] = 1;
    blockwk[12][0] = 90;
...
static void test_scr81a_mapinit_sets_primary_and_secondary_colors(
    test_context *ctx) {
    reset_scr81a_state();
...
static void test_scr81a_noop_entry_points_are_callable(test_context *ctx) {
    reset_scr81a_state();
...
TEST_MAIN_BEGIN;
test_scr81a_main_chk_selects_active_player(&ctx);
test_scr81a_scr_set_uses_default_start_and_parallax(&ctx);
test_scr81a_scr_set_loads_saved_position_when_plflag_is_set(&ctx);
test_scr81a_scr_set_saved_position_clamps_to_scroll_limits(&ctx);
test_scr81a_scr_set_uses_end_demo_position(&ctx);
test_scr81a_mapadrset_empty_and_populated_screens(&ctx);
test_scr81a_mapadrset_clamps_high_offsets(&ctx);
test_scr81a_mapadrset2_reports_block_pointer_and_empty_screen(&ctx);
test_scr81a_vram_address_masks_to_tile_grid(&ctx);
test_scr81a_blockwrt_emits_unflipped_and_flipped_quads(&ctx);
test_scr81a_blockwrt_emits_single_axis_flips(&ctx);
test_scr81a_scroll_respects_start_guard(&ctx);
test_scr81a_scroll_moves_right_and_builds_hscroll(&ctx);
test_scr81a_scroll_moves_left_and_flags_horizontal_edge(&ctx);
test_scr81a_scroll_h_exact_center_and_left_limit(&ctx);
test_scr81a_scroll_h_clamps_to_right_limit(&ctx);
test_scr81a_scroll_negative_parallax_flags(&ctx);
test_scr81a_scrollb_v_flags_up_and_down_edges(&ctx);
test_scr81a_vertical_move_paths_and_limits(&ctx);
test_scr81a_vertical_edge_branches(&ctx);
test_scr81a_direct_vertical_helpers_cover_small_moves(&ctx);
test_scr81a_vertical_special_posture_paths(&ctx);
test_scr81a_scroll_wraps_vertical_edges(&ctx);
test_scr81a_scrollwrt_processes_all_screen_flags(&ctx);
test_scr81a_scrollwrtb_bit2_and_empty_paths(&ctx);
test_scr81a_mapwrt_and_block_wrt_emit_grid_updates(&ctx);
test_scr81a_block_wrt_visible_region_emits_grid_update(&ctx);
test_scr81a_mapinit_sets_primary_and_secondary_colors(&ctx);
test_scr81a_noop_entry_points_are_callable(&ctx);
TEST_MAIN_END
