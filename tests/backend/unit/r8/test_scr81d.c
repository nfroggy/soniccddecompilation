...
static void reset_scr81d_state(void) {
...
static void test_scr81d_main_chk_selects_active_player(test_context *ctx) {
    reset_scr81d_state();
    main_play = 0;
...
static void test_scr81d_scr_set_uses_default_start_and_parallax(
    test_context *ctx) {
    reset_scr81d_state();
...
static void test_scr81d_scr_set_loads_saved_position_when_plflag_is_set(
    test_context *ctx) {
    reset_scr81d_state();
    plflag = 1;
...
static void test_scr81d_mapadrset_empty_and_populated_screens(
    test_context *ctx) {
    Sint32 index = 123;
...
static void test_scr81d_vram_address_masks_to_tile_grid(test_context *ctx) {
    POINT tile = {0, 0};
...
static void test_scr81d_blockwrt_emits_unflipped_and_flipped_quads(
    test_context *ctx) {
    POINT tile = {4, 6};
...
#define SCR81_RESET reset_scr81d_state
#include "test_scr81_common.inc"
#undef SCR81_RESET

static void test_scr81d_scroll_respects_start_guard(test_context *ctx) {
    reset_scr81d_state();
    scroll_start.b.h = 1;
    scrflaga.w = 0x1234;
...
static void test_scr81d_mapinit_sets_primary_and_secondary_colors(
    test_context *ctx) {
    reset_scr81d_state();
...
TEST_MAIN_BEGIN;
test_scr81d_main_chk_selects_active_player(&ctx);
test_scr81d_scr_set_uses_default_start_and_parallax(&ctx);
test_scr81d_scr_set_loads_saved_position_when_plflag_is_set(&ctx);
test_scr81_scr_set_saved_position_clamps_to_scroll_limits(&ctx);
test_scr81_scr_set_uses_end_demo_position(&ctx);
test_scr81d_mapadrset_empty_and_populated_screens(&ctx);
test_scr81_mapadrset_clamps_high_offsets(&ctx);
test_scr81_mapadrset2_reports_block_pointer_and_empty_screen(&ctx);
test_scr81d_vram_address_masks_to_tile_grid(&ctx);
test_scr81_vram_address_extra_entry_points(&ctx);
test_scr81d_blockwrt_emits_unflipped_and_flipped_quads(&ctx);
test_scr81_blockwrt_emits_single_axis_flips(&ctx);
test_scr81d_scroll_respects_start_guard(&ctx);
...
test_scr81d_mapinit_sets_primary_and_secondary_colors(&ctx);
