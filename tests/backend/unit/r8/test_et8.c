...
static void reset_et8_state(void) {
    generate_flag = 0;
    time_flag = 0;
...
static void test_et8_tables_capture_literal_data(test_context *ctx) {
...
static void test_et8_initializes_present_generator_and_waits(test_context *ctx) {
...
static void test_et8_initializes_inactive_generator_states(test_context *ctx) {
    sprite_status *actor = &actwk[2];
...
static void test_et8_hover_moves_and_reverses_on_exact_ticks(test_context *ctx) {
    sprite_status *actor = &actwk[2];
...
static void test_et8_collision_scores_and_clears_player_ride(test_context *ctx) {
    sprite_status *actor = &actwk[2];
...
static void test_et8_collision_skips_ride_clear_when_not_hitched(
    test_context *ctx) {
    sprite_status *actor = &actwk[2];
...
static void test_et8_die_allocates_explosion_at_scripted_offset(
    test_context *ctx) {
    sprite_status *actor = &actwk[2];
...
static void test_et8_die_advances_even_when_actor_pool_is_full(
    test_context *ctx) {
    sprite_status *actor = &actwk[2];
...
static void test_et8_die_waits_when_script_time_has_not_arrived(
    test_context *ctx) {
    sprite_status *actor = &actwk[2];
...
static void test_et8_recovery_waits_then_restores_original_height(
    test_context *ctx) {
    sprite_status *actor = &actwk[2];
...
TEST_MAIN_BEGIN;
    test_et8_tables_capture_literal_data(&ctx);
    test_et8_initializes_present_generator_and_waits(&ctx);
    test_et8_initializes_inactive_generator_states(&ctx);
    test_et8_hover_moves_and_reverses_on_exact_ticks(&ctx);
    test_et8_collision_scores_and_clears_player_ride(&ctx);
    test_et8_collision_skips_ride_clear_when_not_hitched(&ctx);
    test_et8_die_allocates_explosion_at_scripted_offset(&ctx);
    test_et8_die_advances_even_when_actor_pool_is_full(&ctx);
    test_et8_die_waits_when_script_time_has_not_arrived(&ctx);
    test_et8_die_enters_recovery_after_script_ends(&ctx);
    test_et8_recovery_waits_then_restores_original_height(&ctx);
TEST_MAIN_END
