...
static const Uint8 expected_plchg58[] = {1, 137, 138, 255};
...
static void test_player6_animation_streams_match_literals(test_context *ctx) {
    ...
    CHECK_BYTES(ctx, plchg58, expected_plchg58);
}

static void test_player6_playchg_pointer_table_matches_literals(
    test_context *ctx) {
    Uint8 *expected[] = {
        ...
        plchg56, plchg57, plchg58, plchg55};
...
TEST_MAIN_BEGIN;
    test_player6_animation_streams_match_literals(&ctx);
    test_player6_playchg_pointer_table_matches_literals(&ctx);
TEST_MAIN_END
