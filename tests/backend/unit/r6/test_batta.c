...
static void test_batta_lateral_collision_helper(test_context *ctx) {
    ...
    reset_batta_state();
    batta_work_get(actor)->facing_flag = 255;
    emycol_r_result = -7;
    ...
    reset_batta_state();
    batta_work_get(actor)->facing_flag = 1;
    emycol_l_result = 9;
    emylr_jump(actor, 8);
...
static void test_batta_down_floor_wall_and_gravity_paths(test_context *ctx) {
    ...
    emycol_d_result = 3;
    emycol_r_result = -1;
    batta_work_get(actor)->wall_probe_offset = -16;
    batta_down(actor);
    ...
    emycol_d_result = 0;
    emycol_r_result = 0;
    batta_work_get(actor)->x_velocity = 65536;
    batta_work_get(actor)->y_velocity = 0;
    batta_down(actor);
    ...
    emycol_d_result = 0;
    emycol_r_result = 0;
    batta_work_get(actor)->y_velocity = 458752;
    batta_down(actor);
    batta_down(actor);
}
...
static void test_batta_wait_release_paths(test_context *ctx) {
    ...
    actor->yposi.w.h = 100;
    actor->patno = 0;
    batta_work_get(actor)->wait_timer = 11;
    batta_wait(actor);
    ...
    actor->yposi.w.h = 100;
    actor->patno = 1;
    batta_work_get(actor)->wait_timer = 6;
    batta_wait(actor);
    ...
    actor->yposi.w.h = 100;
    actor->patno = 0;
    batta_work_get(actor)->hop_count = 1;
    batta_work_get(actor)->wait_timer = 1;
    batta_wait(actor);
    ...
    actor->patno = 1;
    batta_work_get(actor)->facing_flag = 1;
    batta_work_get(actor)->hop_count = 0;
    batta_work_get(actor)->wait_timer = 1;
    batta_wait(actor);
}
...
static void test_batta_up_wall_ceiling_and_fall_paths(test_context *ctx) {
    ...
    emycol_u_result = 0;
    emycol_r_result = 0;
    batta_work_get(actor)->y_velocity = -16384;
    batta_up(actor);
    ...
    emycol_u_result = 0;
    emycol_r_result = 0;
    batta_work_get(actor)->y_velocity = -4096;
    batta_up(actor);
}
