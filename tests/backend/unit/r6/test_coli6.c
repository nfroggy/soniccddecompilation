...
static void test_coli6_tables_capture_literal_data(test_context *ctx) {
    ...
    TEST_ASSERT_EQ_INT(ctx, 2, colitbl[62][0]);
    TEST_ASSERT_EQ_INT(ctx, 12, colitbl[62][1]);
...
TEST_MAIN_BEGIN;
test_coli6_tables_capture_literal_data(&ctx);
