...
static void reset_scr62a_state(void) {
...
static void test_scr62a_scr_set_and_saved_position(test_context *ctx) {
    reset_scr62a_state();
...
static void test_scr62a_horizontal_and_vertical_scroll(test_context *ctx) {
    int_union pos;
...
static void test_scr62a_parallax_and_hscroll_lines(test_context *ctx) {
    Sint16 *line_ptr;
...
static void test_scr62a_map_and_block_helpers(test_context *ctx) {
    Sint32 index;
    Uint16 *block_ptr;
    POINT tile;
...
static void test_scr62a_scroll_write_and_mapinit(test_context *ctx) {
    Uint8 flag;
...
static void test_scr62a_scroll_wrapper_and_extra_edges(test_context *ctx) {
    POINT tile;
...
static void test_scr62a_additional_position_and_scroll_edges(test_context *ctx) {
    int_union pos;
...
static void test_scr62a_vertical_pose_branches(test_context *ctx) {
    reset_scr62a_state();
    scra_vline = 96;
    scralim_down = 1808;
    scra_v_posit.w.h = 100;
...
static void test_scr62a_blockwrt_flip_orders(test_context *ctx) {
    POINT tile;
...
static void test_scr62a_map_block_edges_and_noops(test_context *ctx) {
    Sint32 index;
    Uint16 *block_ptr;
    POINT tile;
...
static void test_scr62a_scroll_write_helper_paths(test_context *ctx) {
    Uint8 flag;
    POINT tile;
...
static void test_scr62a_negative_parallax_and_writer_edges(test_context *ctx) {
    Uint8 flag;
...
static void test_scr62a_scrollwrt_foreground_and_block_write(
    test_context *ctx) {
    reset_scr62a_state();
    blockwk[0][0] = 91;
    blockwk[0][1] = 92;
...
TEST_MAIN_BEGIN;
    test_scr62a_scr_set_and_saved_position(&ctx);
    test_scr62a_horizontal_and_vertical_scroll(&ctx);
    test_scr62a_parallax_and_hscroll_lines(&ctx);
    test_scr62a_map_and_block_helpers(&ctx);
    test_scr62a_scroll_write_and_mapinit(&ctx);
    test_scr62a_scroll_wrapper_and_extra_edges(&ctx);
    test_scr62a_additional_position_and_scroll_edges(&ctx);
    test_scr62a_vertical_pose_branches(&ctx);
    test_scr62a_blockwrt_flip_orders(&ctx);
    test_scr62a_map_block_edges_and_noops(&ctx);
    test_scr62a_scroll_write_helper_paths(&ctx);
    test_scr62a_negative_parallax_and_writer_edges(&ctx);
    test_scr62a_scrollwrt_foreground_and_block_write(&ctx);
TEST_MAIN_END;
