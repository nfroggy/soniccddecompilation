...
#ifndef TEST_SCR41_DEFAULT_Y
#define TEST_SCR41_DEFAULT_Y 64
#endif
#ifndef TEST_SCR41_SCRALIM_RIGHT
#define TEST_SCR41_SCRALIM_RIGHT 7319
#endif
#ifndef TEST_SCR41_DEFAULT_SCROLLED_Y
#define TEST_SCR41_DEFAULT_SCROLLED_Y 0
#endif
#ifndef TEST_SCR41_DEFAULT_SCRB_Y
#define TEST_SCR41_DEFAULT_SCRB_Y 0
#endif
#ifndef TEST_SCR41_SCRALIM_DOWN
#define TEST_SCR41_SCRALIM_DOWN 1296
#endif
#ifndef TEST_SCR41_DEMO_X
#define TEST_SCR41_DEMO_X 5968
#endif
#ifndef TEST_SCR41_DEMO_Y
#define TEST_SCR41_DEMO_Y 189
#endif
#ifndef TEST_SCR41_DEMO_SCROLLED_X
#define TEST_SCR41_DEMO_SCROLLED_X 5808
#endif
#ifndef TEST_SCR41_DEMO_SCROLLED_Y
#define TEST_SCR41_DEMO_SCROLLED_Y 93
#endif
#ifndef TEST_SCR41_DEMO_SCRB_Y
#define TEST_SCR41_DEMO_SCRB_Y 46
#endif
#ifndef TEST_SCR41_KEEP_DEMO_X
#define TEST_SCR41_KEEP_DEMO_X -1
#endif
#ifndef TEST_SCR41_KEEP_DEMO_Y
#define TEST_SCR41_KEEP_DEMO_Y 0
#endif
#ifndef TEST_SCR41_KEEP_DEMO_SCROLLED_X
#define TEST_SCR41_KEEP_DEMO_SCROLLED_X 0
#endif
#ifndef TEST_SCR41_KEEP_DEMO_SCROLLED_Y
#define TEST_SCR41_KEEP_DEMO_SCROLLED_Y 0
#endif
#ifndef TEST_SCR41_KEEP_DEMO_SCRB_Y
#define TEST_SCR41_KEEP_DEMO_SCRB_Y 0
#endif
#ifndef TEST_SCR41_UP_WRAP_SCRA
#define TEST_SCR41_UP_WRAP_SCRA 1748
#endif
#ifndef TEST_SCR41_UP_WRAP_ACT
#define TEST_SCR41_UP_WRAP_ACT 1948
#endif
#ifndef TEST_SCR41_FAST_NEG_VZ
#define TEST_SCR41_FAST_NEG_VZ 0
#endif
#ifndef TEST_SCR41_SLOW_NEG_VZ
#define TEST_SCR41_SLOW_NEG_VZ 0
#endif
#ifndef TEST_SCR41_MAIN1_NEG_VZ
#define TEST_SCR41_MAIN1_NEG_VZ 0
#endif
#ifndef TEST_SCR41_NEG_SCROLLB_V
#define TEST_SCR41_NEG_SCROLLB_V 0
#endif
#ifndef TEST_SCR41_SCROLL_HBUFFER0
#define TEST_SCR41_SCROLL_HBUFFER0 -13108
#endif
...
#ifndef TEST_SCR41_SOURCE
#define TEST_SCR41_SOURCE "src/r4/scr41c.c"
#endif

#include TEST_SCR41_SOURCE
...
static void reset_scr41c_state(void) {
...
static void test_scr41c_main_chk_and_start_positions(test_context *ctx) {
    reset_scr41c_state();
    ...
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_SCRALIM_RIGHT, scralim_right);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_SCRALIM_DOWN, scralim_down);
    TEST_ASSERT_EQ_INT(ctx, 80, actwk[0].xposi.w.h);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_DEFAULT_Y, actwk[0].yposi.w.h);
    TEST_ASSERT_EQ_INT(ctx, 0, scra_h_posit.w.h);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_DEFAULT_SCROLLED_Y,
                       scra_v_posit.w.h);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_DEFAULT_SCRB_Y, scrb_v_posit.w.h);

    reset_scr41c_state();
    demoflag.w = -32768;
    enddemono = 2;
    scr_set();
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_DEMO_X, actwk[0].xposi.w.h);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_DEMO_Y, actwk[0].yposi.w.h);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_DEMO_SCROLLED_X,
                       scra_h_posit.w.h);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_DEMO_SCROLLED_Y,
                       scra_v_posit.w.h);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_DEMO_SCRB_Y, scrb_v_posit.w.h);

    if (TEST_SCR41_KEEP_DEMO_X >= 0) {
        reset_scr41c_state();
        lpKeepWork->demoflag.w = 1;
        scr_set();
        TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_KEEP_DEMO_X,
                           actwk[0].xposi.w.h);
        TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_KEEP_DEMO_Y,
                           actwk[0].yposi.w.h);
        TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_KEEP_DEMO_SCROLLED_X,
                           scra_h_posit.w.h);
        TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_KEEP_DEMO_SCROLLED_Y,
                           scra_v_posit.w.h);
        TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_KEEP_DEMO_SCRB_Y,
                           scrb_v_posit.w.h);
    }
    ...
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_SCRALIM_RIGHT, scra_h_posit.w.h);
    TEST_ASSERT_EQ_INT(ctx, 0, scra_v_posit.w.h);
}

static void test_scr41c_addressing_and_grid_writes(test_context *ctx) {
    POINT tile = {4, 6};
    Sint32 index = 123;
...
static void test_scr41c_horizontal_and_vertical_scroll_helpers(
    test_context *ctx) {
    int_union dx;
    int_union dy;
...
static void test_scr41c_extra_scroll_helper_branches(test_context *ctx) {
    int_union dx;
    int_union dy;
    int_union move;
    ...
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_FAST_NEG_VZ, scra_vz);

    reset_scr41c_state();
    scra_vline = 96;
    sv_move_main((Uint16)-7);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_SLOW_NEG_VZ, scra_vz);
    ...
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_MAIN1_NEG_VZ, scra_vz);
    ...
    move.w.l = -300;
    scrv_up_ch(move);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_UP_WRAP_SCRA, scra_v_posit.w.h);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_UP_WRAP_ACT, actwk[0].yposi.w.h);
    ...
    dy.l = -1;
    scrollb_hv(&dx, &dy);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_NEG_SCROLLB_V, scrb_v_posit.l);
}

static void test_scr41c_layer_scroll_helpers(test_context *ctx) {
    int_union dx;
    int_union dy;
...
static void test_scr41c_scroll_and_map_write_paths(test_context *ctx) {
    reset_scr41c_state();
    scr_set();
    ...
    TEST_ASSERT_EQ_INT(ctx, 16, scra_h_posit.w.h);
    TEST_ASSERT_EQ_INT(ctx, 4096, scra_hz);
    TEST_ASSERT_EQ_INT(ctx, TEST_SCR41_SCROLL_HBUFFER0,
                       hscroll_buffer[0].w.h);
...
static void test_scr41c_extra_map_and_block_paths(test_context *ctx) {
    POINT tile = {62, 30};
    Sint32 index = 77;
    Uint16 *block = (Uint16 *)1;
...
static void test_scr41c_mapinit_and_noop_entry_points(test_context *ctx) {
    reset_scr41c_state();
...
TEST_MAIN_BEGIN;
test_scr41c_main_chk_and_start_positions(&ctx);
test_scr41c_addressing_and_grid_writes(&ctx);
test_scr41c_horizontal_and_vertical_scroll_helpers(&ctx);
test_scr41c_extra_scroll_helper_branches(&ctx);
test_scr41c_layer_scroll_helpers(&ctx);
test_scr41c_scroll_and_map_write_paths(&ctx);
test_scr41c_extra_map_and_block_paths(&ctx);
test_scr41c_mapinit_and_noop_entry_points(&ctx);
TEST_MAIN_END
