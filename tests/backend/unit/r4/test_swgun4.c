...
static void test_swgun4_init_spawns_children(test_context *ctx) {
    ...
    TEST_ASSERT_EQ_INT(ctx, 300, swgun4_get_work(actor)->swgun.origin_x);
    TEST_ASSERT_EQ_INT(ctx, 500, swgun4_get_work(actor)->swgun.origin_y);
    TEST_ASSERT_EQ_INT(ctx, 3, swgun4_get_work(actor)->swgun.master_index);
    TEST_ASSERT_EQ_INT(ctx, 5, actwkchk_count);
    TEST_ASSERT_EQ_INT(ctx, 63, actwk[20].actno);
    TEST_ASSERT_EQ_INT(ctx, 1, swgun4_get_work(&actwk[20])->swgun.switch_index);
    ...
    TEST_ASSERT_EQ_INT(ctx, 5, swgun4_get_work(&actwk[24])->swgun.switch_index);
    ...
    reset_swgun4_state();
    actor = &actwk[3];
    swgun4_get_work(actor)->swgun.switch_index = 2;
...
static void test_switch_move_press_release_and_fire(test_context *ctx) {
    ...
    reset_swgun4_state();
    swgun4_get_work(actor)->swgun.master_index = 3;
    actor->r_no0 = 2;
    actor->sprvsize = 8;
    swgun4_get_work(actor)->swgun.switch_index = 1;
    master->actno = 63;
    pltime.b.b3 = 20;
    hitchk_u_result = 1;
    ...
    TEST_ASSERT_EQ_INT(ctx, 255, swgun4_get_work(actor)->swgun.current_pressed);
    TEST_ASSERT_EQ_INT(ctx, 4,
                       swgun4_get_work(master)->swgun.active_switch_index);
    TEST_ASSERT_EQ_INT(ctx, 3, swgun4_get_work(actor)->swgun.reward_type);
    TEST_ASSERT_EQ_INT(ctx, 3, swgun4_get_work(master)->swgun.reward_type);
    ...
    TEST_ASSERT_EQ_INT(ctx, 16, swgun4_get_work(actor)->swgun.press_ramp);
    assert_swgun_action(ctx, actor, 0);

    reset_logs();
    swgun4_get_work(actor)->swgun.previous_pressed = 255;
    swgun4_get_work(actor)->swgun.current_pressed = 255;
    hitchk_u_result = 0;

    swgun4(actor);

    TEST_ASSERT_EQ_INT(ctx, 0, swgun4_get_work(actor)->swgun.current_pressed);
    ...
    TEST_ASSERT_EQ_INT(ctx, 0, swgun4_get_work(actor)->swgun.press_ramp);
    ...
    swgun4_get_work(actor)->swgun.master_index = 3;
    actor->r_no0 = 2;
    swgun4_get_work(actor)->swgun.triggered_sound = 255;
    actor->sprvsize = 8;
    master->actno = 63;
    hitchk_u_result = 1;
...
static void test_swgun4_fire_threshold_and_dispatches(test_context *ctx) {
    ...
    actor->r_no0 = 2;
    swgun4_get_work(actor)->swgun.triggered_sound = 255;
    swgun4_get_work(actor)->swgun.press_ramp = 240;
    swgun4_get_work(master)->swgun.active_switch_index = 4;
    ...
    TEST_ASSERT_EQ_INT(ctx, 0, swgun4_get_work(actor)->swgun.reward_timer);
    TEST_ASSERT_EQ_INT(ctx, 0, swgun4_get_work(actor)->swgun.reward_subtimer);
    TEST_ASSERT_EQ_INT(ctx, 2, actor->patno);

    reset_logs();
    swgun4_get_work(master)->swgun.reward_type = 0;
    swgun4_get_work(master)->swgun.active_switch_index = 5;
    actor->r_no0 = 4;
    ...
    TEST_ASSERT_EQ_INT(ctx, 1, swgun4_get_work(actor)->swgun.reward_timer);
    ...
    swgun4_get_work(actor)->swgun.master_index = 3;
    swgun4_get_work(master)->swgun.active_switch_index = 4;
    swgun4_get_work(master)->swgun.reward_type = 1;
    actor->r_no0 = 4;
    ...
    swgun4_get_work(actor)->swgun.master_index = 3;
    swgun4_get_work(master)->swgun.active_switch_index = 5;
    swgun4_get_work(master)->swgun.reward_type = 2;
    actor->r_no0 = 4;
    swgun4_get_work(actor)->swgun.reward_subtimer = 252;
    ...
    actor->xposi.w.h = 500;
    actor->yposi.w.h = 600;
    swgun4_get_work(actor)->swgun.reward_timer = 240;
    swgun4_get_work(actor)->swgun.reward_subtimer = 0;
    swgun4_get_work(actor)->swgun.reward_type = 3;
    ...
    TEST_ASSERT_EQ_INT(ctx, 1, swgun4_get_work(actor)->swgun.reward_subtimer);
    ...
    swgun4_get_work(master)->swgun.reward_type = 2;
    actor->r_no0 = 4;
    swgun4_get_work(actor)->swgun.reward_timer = 255;
    ...
    swgun4_get_work(master)->swgun.reward_type = 2;
    actor->r_no0 = 4;
    swgun4_get_work(actor)->swgun.reward_timer = 1;
    swgun4_get_work(actor)->swgun.reward_subtimer = 252;

    swgun4(actor);

    TEST_ASSERT_EQ_INT(ctx, 2, swgun4_get_work(actor)->swgun.reward_timer);
    TEST_ASSERT_EQ_INT(ctx, 1, frameout_count);
    ...
    TEST_ASSERT_EQ_INT(ctx, 4, swgun4_get_work(actor)->swgun.reward_subtimer);
    TEST_ASSERT_EQ_INT(ctx, 0, swgun4_get_work(actor)->swgun.reward_timer);
    TEST_ASSERT_EQ_INT(ctx, 0, frameout_count);
    ...
    master = &actwk[3];
    swgun4_get_work(actor)->swgun.master_index = 3;
    swgun4_get_work(master)->swgun.reward_type = 3;
    actor->r_no0 = 4;
    ...
    actor->r_no0 = 4;
    swgun4_get_work(actor)->swgun.reward_type = 3;
    swgun4_get_work(actor)->swgun.reward_timer = 0;

    swgun4(actor);

    TEST_ASSERT_EQ_INT(ctx, 16, swgun4_get_work(actor)->swgun.reward_timer);
    TEST_ASSERT_EQ_INT(ctx, 0, frameout_count);
}
...
static void test_swgun4_frameout_dispatch_paths(test_context *ctx) {
    ...
    swgun4_get_work(actor)->swgun.reward_type = 3;
    swgun4_get_work(actor)->swgun.reward_timer = 240;
    swgun4_get_work(actor)->swgun.reward_subtimer = 21;
...
static void test_ring4_lifecycle(test_context *ctx) {
    ...
    TEST_ASSERT_EQ_INT(ctx, 254, swgun4_get_work(ring)->ring.lifetime);
    TEST_ASSERT_EQ_INT(ctx, 47, swgun4_get_work(ring)->ring.bounce_delay);
    TEST_ASSERT_EQ_INT(ctx, 1, speedset2_count);
    TEST_ASSERT_EQ_INT(ctx, 1, actionsub_count);

    reset_logs();
    ring->r_no0 = 2;
    swgun4_get_work(ring)->ring.bounce_delay = 1;
    swgun4_get_work(ring)->ring.lifetime = 2;
    ring->yspeed.w = 256;
    ring->yposi.w.h = 100;
    emycol_d_result = -4;
    ...
    reset_logs();
    ring->r_no0 = 2;
    swgun4_get_work(ring)->ring.lifetime = 1;
    swgun4_get_work(ring)->ring.bounce_delay = 10;
