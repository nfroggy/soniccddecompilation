...
static void reset_scr12d_state(void) {
...
static void test_scr12d_main_chk_selects_active_player(test_context *ctx) {
    reset_scr12d_state();
...
static void test_scr12d_scr_set_uses_default_start_and_parallax(
    test_context *ctx) {
    reset_scr12d_state();
    ...
    TEST_ASSERT_EQ_INT(ctx, 36, scrb_v_posit.w.h);
...
static void test_scr12d_scr_set_loads_saved_position_when_plflag_is_set(
    test_context *ctx) {
    reset_scr12d_state();
    plflag = 1;
...
static void test_scr12d_scr_set_saved_position_clamps_to_limits(
    test_context *ctx) {
    reset_scr12d_state();
    plflag = 1;
...
static void test_scr12d_scr_set_uses_end_demo_position(test_context *ctx) {
    reset_scr12d_state();
    demoflag.w = -32768;
    enddemono = 2;
...
static void test_scr12d_mapadrset_empty_and_populated_screens(
    test_context *ctx) {
    Sint32 index = 123;
...
static void test_scr12d_mapadrset_clamps_high_offsets(test_context *ctx) {
    Sint32 index = 0;
...
static void test_scr12d_mapadrset2_reports_block_pointer_and_empty_screen(
    test_context *ctx) {
    Sint32 index = 123;
...
static void test_scr12d_vram_address_masks_to_tile_grid(test_context *ctx) {
    POINT tile = {0, 0};
...
static void test_scr12d_blockwrt_emits_all_flip_variants(test_context *ctx) {
    POINT tile = {4, 6};
...
static void test_scr12d_scroll_respects_start_guard(test_context *ctx) {
    reset_scr12d_state();
    scroll_start.b.h = 1;
    scrflaga.w = 0x1234;
...
static void test_scr12d_scroll_moves_right_and_builds_hscroll(
    test_context *ctx) {
    reset_scr12d_state();
    scr_set();
    ...
    TEST_ASSERT_EQ_INT(ctx, 36, scrb_v_posit.w.h);
    TEST_ASSERT_EQ_INT(ctx, 36, vscroll.w.l);
}

static void test_scr12d_scroll_top_band_clamps_hscroll_fill(
    test_context *ctx) {
    reset_scr12d_state();
    scralim_left = 0;
    scralim_right = 3479;
...
static void test_scr12d_scroll_low_band_uses_tail_hscroll_fill(
    test_context *ctx) {
    reset_scr12d_state();
    scralim_left = 0;
    scralim_right = 10391;
...
static void test_scr12d_parallax_helpers_flag_all_directions(
    test_context *ctx) {
    reset_scr12d_state();
    scrb_h_count = 16;
    scrb_v_count = 16;
...
static void test_scr12d_scroll_moves_left_and_flags_horizontal_edge(
    test_context *ctx) {
    reset_scr12d_state();
    scralim_left = 0;
    scralim_right = 3479;
...
static void test_scr12d_scroll_h_center_and_limits(test_context *ctx) {
    reset_scr12d_state();
    scralim_left = 0;
    scralim_right = 120;
    scra_hline = 160;
...
static void test_scr12d_vertical_move_paths_and_limits(test_context *ctx) {
    reset_scr12d_state();
    scralim_up = 0;
    scralim_down = 784;
    scra_vline = 96;
...
static void test_scr12d_vertical_special_posture_paths(test_context *ctx) {
    reset_scr12d_state();
    scralim_up = 0;
    scralim_down = 784;
    scra_vline = 96;
...
static void test_scr12d_vertical_edge_branches(test_context *ctx) {
    reset_scr12d_state();
    scralim_up = 0;
    scralim_down = 784;
    scra_vline = 96;
...
static void test_scr12d_direct_vertical_helpers_cover_small_moves(
    test_context *ctx) {
    int_union lSpd;
...
static void test_scr12d_scroll_wraps_vertical_edges(test_context *ctx) {
    int_union lSpd;
...
static void test_scr12d_scrollwrt_processes_screen_flags(test_context *ctx) {
    reset_scr12d_state();
...
static void test_scr12d_scrollwrtb_bit_paths_and_empty(test_context *ctx) {
    Uint8 flag;
...
static void test_scr12d_mapwrt_and_block_wrt_emit_grid_updates(
    test_context *ctx) {
    reset_scr12d_state();
    seed_screen_zero((Uint8 *)mapwka);
    seed_screen_zero((Uint8 *)mapwkb);
...
static void test_scr12d_block_wrt_visible_region_emits_grid_update(
    test_context *ctx) {
    reset_scr12d_state();
    mapwka[0][0] = 1;
    blockwk[12][0] = 90;
...
static void test_scr12d_mapinit_and_noop_entry_points_are_callable(
    test_context *ctx) {
    reset_scr12d_state();
...
TEST_MAIN_BEGIN;
    test_scr12d_main_chk_selects_active_player(&ctx);
    test_scr12d_scr_set_uses_default_start_and_parallax(&ctx);
    test_scr12d_scr_set_loads_saved_position_when_plflag_is_set(&ctx);
    test_scr12d_scr_set_saved_position_clamps_to_limits(&ctx);
    test_scr12d_scr_set_uses_end_demo_position(&ctx);
    test_scr12d_mapadrset_empty_and_populated_screens(&ctx);
    test_scr12d_mapadrset_clamps_high_offsets(&ctx);
    test_scr12d_mapadrset2_reports_block_pointer_and_empty_screen(&ctx);
    test_scr12d_vram_address_masks_to_tile_grid(&ctx);
    test_scr12d_blockwrt_emits_all_flip_variants(&ctx);
    test_scr12d_scroll_respects_start_guard(&ctx);
    test_scr12d_scroll_moves_right_and_builds_hscroll(&ctx);
    test_scr12d_scroll_top_band_clamps_hscroll_fill(&ctx);
    test_scr12d_scroll_low_band_uses_tail_hscroll_fill(&ctx);
    test_scr12d_parallax_helpers_flag_all_directions(&ctx);
    test_scr12d_scroll_moves_left_and_flags_horizontal_edge(&ctx);
    test_scr12d_scroll_h_center_and_limits(&ctx);
    test_scr12d_vertical_move_paths_and_limits(&ctx);
    test_scr12d_vertical_special_posture_paths(&ctx);
    test_scr12d_vertical_edge_branches(&ctx);
    test_scr12d_direct_vertical_helpers_cover_small_moves(&ctx);
    test_scr12d_scroll_wraps_vertical_edges(&ctx);
    test_scr12d_scrollwrt_processes_screen_flags(&ctx);
    test_scr12d_scrollwrtb_bit_paths_and_empty(&ctx);
    test_scr12d_mapwrt_and_block_wrt_emit_grid_updates(&ctx);
    test_scr12d_block_wrt_visible_region_emits_grid_update(&ctx);
    test_scr12d_mapinit_and_noop_entry_points_are_callable(&ctx);
TEST_MAIN_END
