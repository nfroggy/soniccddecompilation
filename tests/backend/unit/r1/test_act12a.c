...
static void reset_act12a_state(void) {
    actionsub_count = 0;
    actionsub_actor = 0;
    frameout_count = 0;
    frameout_actor = 0;
...
static void test_act12a_table_captures_dispatch_slots(test_context *ctx) {
    ...
    assert_act_entry(ctx, 40, branko1);
...
static void test_act12a_table_entries_dispatch_to_handlers(test_context *ctx) {
    sprite_status actor;
...
TEST_MAIN_BEGIN;
    test_act12a_table_captures_dispatch_slots(&ctx);
    test_act12a_table_entries_dispatch_to_handlers(&ctx);
