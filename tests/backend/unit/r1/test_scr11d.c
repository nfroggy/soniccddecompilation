...
static void reset_scr11d_state(void) {
...
static void test_scr11d_main_chk_selects_active_player(test_context *ctx) {
    reset_scr11d_state();
...
static void test_scr11d_scr_set_default_saved_and_demo_positions(
    test_context *ctx) {
    reset_scr11d_state();
...
static void test_scr11d_scr_set_clamps_saved_position(test_context *ctx) {
    reset_scr11d_state();
    plflag = 1;
...
static void test_scr11d_map_and_vram_address_helpers(test_context *ctx) {
    Sint32 index = 123;
...
static void test_scr11d_blockwrt_emits_all_flip_variants(test_context *ctx) {
    POINT tile = {4, 6};
...
static void test_scr11d_scroll_h_and_parallax_branches(test_context *ctx) {
    reset_scr11d_state();
    scroll_start.b.h = 1;
    scrflaga.w = 0x1234;
...
static void test_scr11d_scroll_and_vertical_paths(test_context *ctx) {
    int_union lSpd;
...
static void test_scr11d_scrollwrt_and_mapwrt_emit_grid_updates(
    test_context *ctx) {
    Uint8 flag;
...
static void test_scr11d_visible_block_wrt_and_mapinit(test_context *ctx) {
    reset_scr11d_state();
    mapwka[0][0] = 1;
    blockwk[12][0] = 90;
    blockwk[12][1] = 91;
...
TEST_MAIN_BEGIN;
    test_scr11d_main_chk_selects_active_player(&ctx);
    test_scr11d_scr_set_default_saved_and_demo_positions(&ctx);
    test_scr11d_scr_set_clamps_saved_position(&ctx);
    test_scr11d_map_and_vram_address_helpers(&ctx);
    test_scr11d_blockwrt_emits_all_flip_variants(&ctx);
    test_scr11d_scroll_h_and_parallax_branches(&ctx);
    test_scr11d_scroll_and_vertical_paths(&ctx);
    test_scr11d_scrollwrt_and_mapwrt_emit_grid_updates(&ctx);
    test_scr11d_visible_block_wrt_and_mapinit(&ctx);
TEST_MAIN_END
