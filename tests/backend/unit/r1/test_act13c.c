...
DECLARE_ACT_STUB(egg1);
DECLARE_ACT_STUB(egg1body);
DECLARE_ACT_STUB(egg1leg1);
DECLARE_ACT_STUB(egg1leg2);
DECLARE_ACT_STUB(egg1leg3);
DECLARE_ACT_STUB(egg1arm1);
DECLARE_ACT_STUB(egg1arm2);
DECLARE_ACT_STUB(egg1arm3);
DECLARE_ACT_STUB(egg1arm4);
...
DEFINE_ACT_STUB(egg1)
DEFINE_ACT_STUB(egg1body)
DEFINE_ACT_STUB(egg1leg1)
DEFINE_ACT_STUB(egg1leg2)
DEFINE_ACT_STUB(egg1leg3)
DEFINE_ACT_STUB(egg1arm1)
DEFINE_ACT_STUB(egg1arm2)
DEFINE_ACT_STUB(egg1arm3)
DEFINE_ACT_STUB(egg1arm4)
...
static void reset_act13c_state(void) {
    actionsub_count = 0;
    actionsub_actor = 0;
    frameout_count = 0;
    frameout_actor = 0;
...
static void test_act13c_table_captures_dispatch_slots(test_context *ctx) {
    ...
    assert_act_entry(ctx, 41, egg1);
    assert_act_entry(ctx, 42, egg1body);
    assert_act_entry(ctx, 43, egg1leg1);
    assert_act_entry(ctx, 44, egg1leg2);
    assert_act_entry(ctx, 45, egg1leg3);
    assert_act_entry(ctx, 46, egg1arm1);
    assert_act_entry(ctx, 47, egg1arm2);
    assert_act_entry(ctx, 48, egg1arm3);
    assert_act_entry(ctx, 49, egg1arm4);
...
static void test_act13c_table_entries_dispatch_to_handlers(test_context *ctx) {
    sprite_status actor;
...
TEST_MAIN_BEGIN;
    test_act13c_table_captures_dispatch_slots(&ctx);
    test_act13c_table_entries_dispatch_to_handlers(&ctx);
