...
static void reset_coli1_state(void) {
...
static void test_coli1_tables_capture_r1_collision_contract(test_context *ctx) {
    ...
    TEST_ASSERT_EQ_INT(ctx, 12, colitbl[62][0]);
...
TEST_MAIN_BEGIN;
    test_coli1_tables_capture_r1_collision_contract(&ctx);
