...
static sprite_pattern spat02 = {1, {{-16, -32, 0, SPRITE_SPRING_BASE + 2}}};
static sprite_pattern spat03 = {1, {{-8, -16, 0, SPRITE_SPRING_BASE + 3}}};
static sprite_pattern spat04 = {1, {{-8, -16, 0, SPRITE_SPRING_BASE + 4}}};
static sprite_pattern spat05 = {1, {{-8, -16, 0, SPRITE_SPRING_BASE + 5}}};
static sprite_pattern spat06 = {1, {{-16, -16, 0, SPRITE_SPRING_BASE + 6}}};
static sprite_pattern spat07 = {1, {{-16, -16, 0, SPRITE_SPRING_BASE + 7}}};
static sprite_pattern spat08 = {1, {{-16, -32, 0, SPRITE_SPRING_BASE + 8}}};
static sprite_pattern kpat00 = {1, {{-8, -8, 0, SPRITE_SPRING_BASE + 9}}};
static sprite_pattern kpat01 = {1, {{-8, -8, 0, SPRITE_SPRING_BASE + 10}}};
static sprite_pattern ipat00 = {1, {{-20, -16, 0, SPRITE_SPRING_BASE + 11}}};
static sprite_pattern spat10 = {1, {{-16, -8, 0, SPRITE_SPRING_BASE + 12}}};
static sprite_pattern spat11 = {1, {{-16, 0, 0, SPRITE_SPRING_BASE + 13}}};
static sprite_pattern spat12 = {1, {{-16, -32, 0, SPRITE_SPRING_BASE + 14}}};
static sprite_pattern spat13 = {1, {{-8, -16, 0, SPRITE_SPRING_BASE + 15}}};
static sprite_pattern spat14 = {1, {{-8, -16, 0, SPRITE_SPRING_BASE + 16}}};
static sprite_pattern spat15 = {1, {{-8, -16, 0, SPRITE_SPRING_BASE + 17}}};
static sprite_pattern spat16 = {1, {{-16, -16, 0, SPRITE_SPRING_BASE + 18}}};
static sprite_pattern spat17 = {1, {{-16, -16, 0, SPRITE_SPRING_BASE + 19}}};
static sprite_pattern spat18 = {1, {{-16, -32, 0, SPRITE_SPRING_BASE + 20}}};
sprite_pattern *springpat[3] = {&spat00, &spat01, &spat02};
sprite_pattern *spring90pat[3] = {&spat03, &spat04, &spat05};
sprite_pattern *spring45pat[3] = {&spat06, &spat07, &spat08};
sprite_pattern *springpat2[3] = {&spat10, &spat11, &spat12};
sprite_pattern *spring90pat2[3] = {&spat13, &spat14, &spat15};
sprite_pattern *spring45pat2[3] = {&spat16, &spat17, &spat18};
sprite_pattern *komapat[2] = {&kpat00, &kpat01};
sprite_pattern *iwapat[1] = {&ipat00};
char springchg0[12] = {0, 0, 1, 1, 2, 2, 2, 2, 2, 2, 1, -4};
char *springchg[1] = {springchg0};
char komachg0[4] = {8, 0, 1, -1};
char *komachg[1] = {komachg0};
void (*sjump_move_tbl[13])(sprite_status *) = {
    &sjumpinit,  &sjumpmove,   &sjumpmove2, &sjumpmove3,  &sdushmove,
    &sdushmove2, &sdushmove3,  &sjump2move, &sjump2move2, &sjump2move3,
    &sjump3move, &sjump3move2, &sjump3move3};
...
void sjump2move(sprite_status *actionwk) {
    ...
    a1 = &actwk[0];
    if (ride_on_chk_s2(actionwk, a1) == 0)
        return;
