...
static sprite_pattern tpat00 = {1, {{-40, 16, 0, SPRITE_ET1_BASE}}};
static sprite_pattern tpat01 = {1, {{-40, 16, 0, SPRITE_ET1_BASE + 1}}};
static sprite_pattern tpat07 = {1, {{0, 0, 0, 0}}};
static sprite_pattern tpat02 = {
    2,
    {{-24, -32, 0, SPRITE_ET1_BASE + 7}, {-40, -32, 0, SPRITE_ET1_BASE + 8}}};
