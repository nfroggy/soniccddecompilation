...
sprite_pattern ringsp0 = {1, {{-8, -8, 0, SPRITE_RING_BASE}}};
sprite_pattern ringsp1 = {1, {{-8, -8, 0, SPRITE_RING_BASE + 1}}};
sprite_pattern ringsp2 = {1, {{-4, -8, 0, SPRITE_RING_BASE + 2}}};
sprite_pattern ringsp3 = {1, {{-8, -8, 0, SPRITE_RING_BASE + 3}}};
sprite_pattern ringsp4 = {1, {{-8, -8, 0, SPRITE_RING_BASE + 4}}};
sprite_pattern ringsp5 = {1, {{-8, -8, 0, SPRITE_RING_BASE + 5}}};
sprite_pattern ringsp6 = {1, {{-8, -8, 0, SPRITE_RING_BASE + 6}}};
sprite_pattern ringsp7 = {1, {{-8, -8, 0, SPRITE_RING_BASE + 7}}};
sprite_pattern ringsp8;
sprite_pattern *ringpat[9] = {&ringsp0, &ringsp1, &ringsp2, &ringsp3, &ringsp4,
                              &ringsp5, &ringsp6, &ringsp7, &ringsp8};
...
void ringinit(sprite_status *pActwk) {
    char ringtbl[32] = {16,  0,  24, 0,  32, 0,  0,   16,  0,   24,  0,
                        32,  16, 16, 24, 24, 32, 32,  -16, 16,  -24, 24,
                        -32, 32, 16, 8,  24, 16, -16, 8,   -24, 16};
    Sint32 fw_index;
    Sint32 i;
    char ring_counter;
    ...
    i = fw_index + 1;
    do {
        if (flagwork[--i] & (1 << (ring_counter - 1)))
            goto label3;
    } while (--d0 != -1);
...
void ringerase(sprite_status *pActwk) { frameout(pActwk); }

void flyring(sprite_status *pActwk) {
    void (*flyring_move_tbl[5])(sprite_status *) = {
        &flyringinit, &flyringmove, &flyringget, &flyringdie, &flyringerase};
...
void flyringerase(sprite_status *pActwk) { frameout(pActwk); }
