...
static sprite_pattern pat00 = {1, {{-16, -16, 0, SPRITE_WALL1_BASE}}};
static sprite_pattern pat01 = {1, {{-16, -16, 0, SPRITE_WALL1_BASE + 1}}};
static sprite_pattern pat02 = {1, {{-32, -16, 0, SPRITE_WALL1_BASE + 2}}};
static sprite_pattern pat03 = {1, {{-16, -32, 0, SPRITE_WALL1_BASE + 3}}};
static sprite_pattern pat04 = {1, {{-32, -32, 0, SPRITE_WALL1_BASE + 4}}};
static sprite_pattern pat05 = {1, {{-64, -16, 0, SPRITE_WALL1_BASE + 5}}};
static sprite_pattern pat06 = {1, {{-16, -64, 0, SPRITE_WALL1_BASE + 6}}};
sprite_pattern *pat_wall1[7] = {&pat00, &pat01, &pat02, &pat03,
                                &pat04, &pat05, &pat06};
static Uint8 tbl0[14] = {16, 16, 16, 16, 32, 16, 16,
                         32, 32, 32, 64, 16, 16, 64};
