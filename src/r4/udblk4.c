...
static void type4_coset(sprite_status* pActwk, sprite_status* pNewActwk, Uint8 d0, Sint16 d1);
...
static void type5_coset(sprite_status* pActwk, sprite_status* pNewActwk, Uint8 d0, Sint16 d1, Uint8 d2, Sint16 d3);
...
static void type7_coset(sprite_status* pActwk, sprite_status* pNewActwk, Uint8 d0, Sint16 d1, Uint8 d2);
