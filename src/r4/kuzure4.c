...
static sprite_pattern pat_kuzure_00 = {1, {{-8, -16, 0, SPRITE_KUZURE4_BASE}}};
static sprite_pattern pat_kuzure_01 = {
    1, {{-16, -16, 0, SPRITE_KUZURE4_BASE + 1}}};
static sprite_pattern pat_kuzure_02 = {
    1, {{-24, -16, 0, SPRITE_KUZURE4_BASE + 2}}};
static sprite_pattern pat_kuzure_03 = {
    1, {{-32, -16, 0, SPRITE_KUZURE4_BASE + 3}}};
static sprite_pattern pat_kuzure_04 = {
    1, {{-40, -16, 0, SPRITE_KUZURE4_BASE + 4}}};
static sprite_pattern pat_kuzure_05 = {
    1, {{-48, -16, 0, SPRITE_KUZURE4_BASE + 5}}};
static sprite_pattern pat_kuzure_06 = {
    1, {{-56, -16, 0, SPRITE_KUZURE4_BASE + 6}}};
static sprite_pattern pat_kuzure_07 = {
    1, {{-64, -16, 0, SPRITE_KUZURE4_BASE + 7}}};
static sprite_pattern pat_kuzure_08 = {1,
                                       {{-8, -8, 0, SPRITE_KUZURE4_BASE + 8}}};
sprite_pattern *pat_kuzure_a[9] = {
    &pat_kuzure_00, &pat_kuzure_01, &pat_kuzure_02,
    &pat_kuzure_03, &pat_kuzure_04, &pat_kuzure_05,
    &pat_kuzure_06, &pat_kuzure_07, &pat_kuzure_08};
static void (*kuzure4_act_tbl[4])(sprite_status *) = {&main_ini, &main_check,
...
static void main_check(sprite_status *pActwk) {
    if (ridechk(pActwk, &actwk[0])) {
        kuzure4_work *work = kuzure4_work_get(pActwk);
...
static void main_wait(sprite_status *pActwk) {
    ...
    if (--kuzure4_work_get(pActwk)->wait_timer < 0) {
        pActwk->r_no0 += 2;
    }
...
static void main_break(sprite_status *pActwk) {
    ...
    if (kuzure4_work_get(pActwk)->break_step >= 0) {
        xwk *= -1;
    }
    ...
    if (actwkchk(&pNewact) == 0) {
        ...
        kuzure4_work_get(pNewact)->wait_timer = 4;
    ...
    if (--pActwk->userflag.b.h <= 0) {
        ...
        pActwk->sprhs -= 8;
        pActwk->sprhsize -= 8;
        kuzure4_work_get(pActwk)->wait_timer = 7;
        pActwk->xposi.w.h += kuzure4_work_get(pActwk)->break_step;
        ridechk(pActwk, &actwk[0]);
        actionsub(pActwk);
    }
}
...
static void parts_fall(sprite_status *pActwk) {
    ...
    if (!(pActwk->actflg & 128)) {
        ...
        spdwk = kuzure4_work_get(pActwk)->y_velocity + 16384;
        if (spdwk > 1441792) {
            spdwk = 1441792;
        }
        kuzure4_work_get(pActwk)->y_velocity = spdwk;
