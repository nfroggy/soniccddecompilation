...
extern sprite_pattern *escal4pat[];
extern sprite_pattern *boupat[];
extern sprite_pattern *harir4pat[];
extern sprite_pattern *pat_tekkyu[];
extern sprite_pattern *brunko4pat[];
extern sprite_pattern *pat_sw[];
extern sprite_pattern *tobira4pat[];
...
extern sprite_pattern *funsui4pat[];
extern sprite_pattern *swblkr4pat[];
extern sprite_pattern *pat_harid4[];
...
edit_data edit_tbl = {53,
                      0,
                      {{38, 1, escal4pat, 17244},
                       {5, 1, boupat, 760},
                       {34, 1, harir4pat, 928},
                       {38, 1, escal4pat, 17244},
                       {38, 1, escal4pat, 17244, 1, 0, 0, 0},
                       {38, 1, escal4pat, 17244, 2, 0, 0, 1},
                       {38, 1, escal4pat, 17244, 3, 0, 0, 1},
                       {54, 1, pat_tekkyu, 880},
                       {41, 1, brunko4pat, 49984, 16, 0, 0, 0},
                       {41, 1, brunko4pat, 49984},
                       {39, 1, pat_sw, 1290},
                       {40, 1, tobira4pat, 17472, 16, 0, 0, 2},
                       {40, 1, tobira4pat, 17472, 32, 0, 0, 1},
                       {40, 1, tobira4pat, 17472, 48, 0, 0, 0},
                       {40, 1, tobira4pat, 17472, 64, 0, 0, 0},
                       ...
                       {42, 1, funsui4pat, 8960},
                       {48, 1, swblkr4pat, 17514},
                       {50, 1, pat_harid4, 17514},
                       {10, 1, springpat, 1312},
