...
static Sint32 z41aline(Sint32 hsCount);
static void zonescrsetsub0(Sint16 HPosi, Sint16 VPosi, Uint16 offs);
...
void scr_set(void) {
    ...
    Uint16 scr_dir_tbl[6] = {4, 0, 7319, 0, 1296, 96};
    Sint32 i;
...
void scrbinit(Sint16 yWk) {
    ...
    if ((Uint16)scra_v_posit.w.h < 512) {
    ...
    scrz_h_posit.w.h = (Uint16)(yWk >> 4);
    scrc_h_posit.w.h = (Uint16)((yWk >> 5) * 3);
    scrb_h_posit.w.h = (Uint16)((yWk >> 6) * 3);
    for (i = 0; i < 30; ++i) {
...
void scroll(void) {
    ...
    data.w.l &= 2040;
    data.w.l >>= 2;
    zonescrsetsub0(-scra_h_posit.w.h, scrb_v_posit.w.h, data.w.l / 2);
}
...
static Sint32 z41aline(Sint32 hsCount) {
    ...
    int_union data;
    Sint32 i, j;
    Sint32 z41ascrtbl[5] = {14, 10, 4, 2, 2};
    ...
    do {
        if (avp > waterposi) {
            ...
            do {
                ...
                pHScrollBuff->w.l = (Sint16)(char)awasintbl[data1.w] + hsw.w.l;
                ++pHScrollBuff;
                ++data1.b.l;
                ++data2.b.l;
                ++VPosi;
        ...
        for (i = 0; i < 16; ++i) {
            ...
            if (wD0 != 0) {
                if (*pScrFlag & (Uint8)(1 << wD0)) {
                    ...
                    mapadrset(wH_posiw, wV_posiw, wD5, lD4.w.l, pMapWk,
                              &BlkIndex);
...
void mapwrt_z81a(Uint8 *pMapWk, Sint32 VramBase) {
    ...
    do {
        ...
        if (temp.l >= 512) {
            ...
            temp2.l = 0;
            temp2.w.l = wD0;
            temp2.l = (Uint32)temp2.l >> 16 & 65535 | temp2.l << 16 & -65536;
            temp2.l >>= 2;
            temp2.l *= 3;
            temp2.l += 0x2000000;
            temp2.l = (Uint32)temp2.l >> 16 & 65535 | temp2.l << 16 & -65536;
