...
static sprite_pattern et_pat00 = {1, {{-40, 16, 0, SPRITE_ET4_BASE}}};
static sprite_pattern et_pat01 = {1, {{-40, 16, 0, SPRITE_ET4_BASE + 1}}};
static sprite_pattern et_pat02 = {1, {{-40, -32, 0, SPRITE_ET4_BASE + 2}}};
static sprite_pattern et_pat03 = {1, {{-40, -32, 0, SPRITE_ET4_BASE + 3}}};
static sprite_pattern et_pat04 = {1, {{-40, -32, 0, SPRITE_ET4_BASE + 4}}};
static sprite_pattern et_pat05 = {1, {{-40, -32, 0, SPRITE_ET4_BASE + 5}}};
static sprite_pattern et_pat06 = {1, {{-40, -32, 0, SPRITE_ET4_BASE + 6}}};
...
static void m_init(sprite_status *pActwk) {
    et4_work *work = et4_work_get(pActwk);
    Uint8 patnowk;
    Uint16 tbl0sproffset[3][4] = {
        {1104, 1104, 0, 0}, {1104, 1104, 0, 0}, {0, 0, 0, 0}};
...
static void m_die(sprite_status *pActwk) {
    ...
    if (timewk < 0) {
        ...
        pActwk->r_no0 += 2;
        work->delay_timer = 8;
    } else if (++work->delay_timer == (Uint8)timewk) {
