...
static sprite_pattern tpat00 = {1, {{-40, 15, 0, SPRITE_ET8_BASE}}};
static sprite_pattern tpat01 = {1, {{-40, 16, 0, SPRITE_ET8_BASE + 1}}};
static sprite_pattern tpat07 = {1, {{0, 0, 0, 0}}};
static sprite_pattern tpat02 = {
    2,
    {{-24, -32, 0, SPRITE_ET8_BASE + 7}, {-40, -32, 0, SPRITE_ET8_BASE + 8}}};
...
static void m_init(sprite_status *actionwk) {
    et8_work *work = et8_get_work(actionwk);
    Uint16 *a1;
    Uint16 d0;
