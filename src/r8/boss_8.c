...
static Sint32 egg8hane_ini(sprite_status* pActwk, sprite_status* pMecawk, sprite_status* pEggwk);
static Sint32 egg8hane_demo(sprite_status* pActwk, sprite_status* pMecawk, sprite_status* pEggwk);
static Sint32 egg8hane_normal(sprite_status* pActwk, sprite_status* pMecawk, sprite_status* pEggwk);
static Sint32 egg8hane_fire1(sprite_status* pActwk, sprite_status* pMecawk, sprite_status* pEggwk);
static Sint32 egg8hane_wait(sprite_status* pActwk, sprite_status* pMecawk, sprite_status* pEggwk);
static Sint32 egg8hane_kill(sprite_status* pActwk, sprite_status* pMecawk, sprite_status* pEggwk);
...
static void egg8_move_c(sprite_status* pActwk, sprite_status* pMecawk) {
  ...
  if (!pActwk->actfree[3]) {
    ...
    if (!(pActwk->actfree[3] & 1)) {
      ...
      if ((xOfs = ((Sint16*)pActwk)[26]) < pActwk->xposi.w.h) return;
...
tobi_set(pActwk);
    ...
    if (((Sint16*)pActwk)[23] != -32768) return;
...
static void egg8meca_fire(sprite_status* pActwk, sprite_status* pEggwk) {
  ...
  if (pEggwk->actfree[16] == pActwk->actfree[19]) {
    ...
    pActwk->actfree[21] = (actwk[0].xposi.w.h + (Sint16)actwk[0].pattim & 3) * 8;
...
static Sint32(*hane_act_tbl[6])(sprite_status*, sprite_status*, sprite_status*) = {
  &egg8hane_ini,
  &egg8hane_demo,
  &egg8hane_normal,
  &egg8hane_fire1,
...
static Sint32 egg8hane_fire1(sprite_status* pActwk, sprite_status* pMecawk, sprite_status* pEggwk) {
  ...
  char* pResetTbl;
  Sint32 lwk;
  static Sint16 hane_fire_tbl[16] = {
    3776,
    3904,
    3968,
    3712,
...
static Sint16* hibana_offs_tbl[2] = {
  hibana0,
  hibana1
};
...
static Uint32(*hibana_act_tbl[2])(sprite_status*) = {
  &egg8hibana_ini,
  &egg8hibana_1
};
