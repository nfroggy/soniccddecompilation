...
static void z82bline0(Sint16 **ppHscw);
static void z82bline1(Sint16 **ppHscw);
static void line_div(Sint32 hWk1, Sint32 *hWk2, Sint16 sD6);
...
static Uint8 z81awrttbl[33] = {0, 0, 0, 0, 0, 0, 0, 0, 6, 6, 6,
...
Sint16 scr_dir_tbl[6] = {4, 0, 3735, 0, 784, 96};
Sint16 endplpositbl[8][2] = {{80, 944},    {3744, 1132}, {5968, 189},
                             {2560, 1580}, {2992, 76},   {5488, 364},
                             {432, 1836},  {5120, 684}};
Sint16 playpositbl[1][2] = {{48, 588}};
Uint8 playmapnotbl[4] = {127, 127, 127, 127};
...
void scroll(void) {
    ...
    lYwk = (Uint32)scra_v_posit.l >> 3;
    lYwk = (Uint32)lYwk >> 16 & 65535 | lYwk << 16 & -65536;
    ...
    sYnum = (Uint16)(scrb_v_posit.w.h & 1016) >> 2;
...
static void z82bline0(Sint16 **ppHscw) {
    ...
    Sint32 i, j;
    static char z82bscrtbl0[5] = {3, 3, 3, 1, 1};
    ...
    for (i = 4; i >= 0; --i) {
        ...
        for (j = z82bscrtbl0[i]; j >= 0; --j) {

            **ppHscw = ldWk1.w.l;
            ++*ppHscw;
        }

        ldWk2.l = (Uint32)ldWk2.l >> 16 & 65535 | ldWk2.l << 16 & -65536;
        ldWk2.l += lWk2;
        ldWk2.l = (Uint32)ldWk2.l >> 16 & 65535 | ldWk2.l << 16 & -65536;
    }
}
...
static void z82bline1(Sint16 **ppHscw) {
    ...
    int_union ldWk1, ldWk2;
    Sint32 i, j;
    static char z82bscrtbl1[5] = {1, 3, 1, 3, 1};
...
static void line_div(Sint32 hWk1, Sint32 *hWk2, Sint16 sD6) {
    *hWk2 = (Uint32)(*hWk2 - hWk1 << 6) / sD6 << 10;
}
...
Sint32 block_chk(Uint16 xOffs, Uint16 yOffs) {
    if ((Uint16)((scra_v_posit.w.h & 65520) - 16) <= yOffs) {
        if ((Sint16)((scra_v_posit.w.h + 240 & 65520) - 16) > (Sint16)yOffs) {
            if ((Uint16)((scra_h_posit.w.h & 65520) - 16) < xOffs) {
                if ((Sint16)(scra_h_posit.w.h + 336 & 65520) - 16 >=
                    (Sint16)xOffs) {
