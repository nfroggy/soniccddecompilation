...
_Static_assert(offsetof(trap_r82_work, trigger_timer) == 6,
               "trap_r82_work.trigger_timer offset");
_Static_assert(offsetof(trap_r82_work, origin_y) == 8,
               "trap_r82_work.origin_y offset");
_Static_assert(offsetof(trap_r82_work, linked_actor_index) == 10,
               "trap_r82_work.linked_actor_index offset");
_Static_assert(offsetof(trap_r82_work, origin_x) == 12,
               "trap_r82_work.origin_x offset");
_Static_assert(offsetof(trap_r82_work, follow_x_offset) == 14,
               "trap_r82_work.follow_x_offset offset");
_Static_assert(offsetof(trap_r82_work, follow_y_offset) == 15,
               "trap_r82_work.follow_y_offset offset");
_Static_assert(offsetof(trap_r82_work, segment_count) == 17,
               "trap_r82_work.segment_count offset");
_Static_assert(offsetof(trap_r82_work, pattern_index) == 18,
               "trap_r82_work.pattern_index offset");
_Static_assert(offsetof(trap_r82_work, group_index) == 19,
               "trap_r82_work.group_index offset");
_Static_assert(offsetof(trap_r82_work, stopped) == 21,
               "trap_r82_work.stopped offset");
_Static_assert(sizeof(trap_r82_work) <= sizeof(((sprite_status *)0)->actfree),
               "trap_r82_work fits in actfree");

static inline trap_r82_work *trap_r82_work_get(sprite_status *trapwk) {
    return (trap_r82_work *)trapwk->actfree;
}
...
void gater8(sprite_status *trapwk) { frameout(trapwk); }
...
void togeita(sprite_status *trapwk) {
    ...
    trap_r82_work *work = trap_r82_work_get(trapwk);
...
static void togeita_init(sprite_status *trapwk) {
    ...
    if (work->group_index == 0) {
        ...
        new_actwk->actno = 51;
        trap_r82_work_get(new_actwk)->group_index = 1;
        ...
        new_actwk->actno = 51;
        trap_r82_work_get(new_actwk)->group_index = 2;
    ...
    trap_r82_work_get(new_actwk)->pattern_index = trapwk->patno;
    trap_r82_work_get(new_actwk)->linked_actor_index = trapwk - actwk;
...
static void togeita_dataset(sprite_status *trapwk, sprite_status *new_actwk,
    ...
    Uint8 patchg_point;
    trap_r82_work *work = trap_r82_work_get(trapwk);
    trap_r82_work *new_work = trap_r82_work_get(new_actwk);
...
static void setitano(sprite_status *trapwk) {
    Uint8 tbl[56] = {0, 1, 2, 1, 0, 2, 0, 0, 1, 2, 1, 2, 1, 2, 1, 2, 0, 2, 1,
                     2, 0, 1, 2, 1, 1, 2, 1, 2, 2, 1, 2, 2, 1, 2, 1, 1, 0, 1,
                     2, 0, 1, 2, 2, 1, 0, 1, 2, 1, 1, 0, 2, 1, 0, 1, 2, 2};

    trap_r82_work_get(trapwk)->pattern_index = tbl[trapwk->userflag.b.h];
}
...
void togedair8(sprite_status *trapwk) {
    ...
    if (trapwk->userflag.b.h == -8) {
        tokusyu_block(trapwk);
        return;
    }
...
static void dair8_init(sprite_status *trapwk) {
    ...
    if (trapwk->userflag.b.h != 1) {
        ...
        new_actwk->xposi.w.h = trapwk->xposi.w.h;
        new_actwk->yposi.w.h = trapwk->yposi.w.h;
        trap_r82_work_get(new_actwk)->follow_y_offset = 232;
        trap_r82_work_get(new_actwk)->linked_actor_index = trapwk - actwk;
        new_actwk->userflag.b.h = trapwk->userflag.b.h;
        dair8_move(trapwk);
    } else {
