...
static Uint8 z81awrttbl[33] = {0, 2, 2, 2, 0, 0, 0, 0, 0, 4, 4,
...
Sint16 endplpositbl[8][2] = {{80, 944},    {3744, 1132}, {5968, 189},
                             ...
                             {432, 1836},  {5120, 684}};
Sint16 playpositbl[2][2] = {{46, 1164}, {6942, 1484}};
...
static void playposiset(void) {
    ...
    if (lpKeepWork->demoflag.w) {
        pPositbl = &playpositbl[1][0];
...
static void z82bline0(Sint16 **ppHscw) {
    ...
    int_union ldwk;
    Sint16 wk;
    static char z82bscrtbl0[7] = {0, 0, 0, 0, 1, 1, 1};

    lXwk = scrc_h_posit.w.h - scrz_h_posit.w.h;
    lXwk = (Uint32)(lXwk << 7) / 5 << 9;
...
static void z82bline1(Sint16 **ppHscw) {
    ...
    int_union ldwk;
    Sint16 wk;
    static char z82bscrtbl1[7] = {0, 0, 0, 0, 1, 9, 1};
