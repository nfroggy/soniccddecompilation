...
static Uint8 gater8pchgl[16] = { 0, 4, 1, 8, 2, 12, 3, 16, 4, 20, 5, 24, 6, 28, 7, 32 };
static Uint8 gater8pchgr[16] = { 8, 4, 9, 8, 10, 12, 11, 16, 12, 20, 13, 24, 14, 28, 15, 32 };
