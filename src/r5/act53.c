...
void (*act_tbl[60])(sprite_status *) = {
    ...
    &flower,    &egg5hibana, &egg5hari,  &egg5belt,  &egg5bakuha, &noact,
    &noact,     &noact,      &noact,     &kuzure5,   &noact,      &noact,
    &noact,     &noact,      &noact,     &noact,     &noact,      &dair5,
    &noact,     &egg5,       &egg5meca1, &egg5meca2, &egg5meca3,  &egg5pipe,
    &egg5catch, &egg5bomb,   &egg5bomb2, &clear,     &over,       &title};
