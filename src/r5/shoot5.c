...
Sint16 shooterposi_7[5] =
{
     8,
  1424, 200,
  1424, 376
};
Sint16 shooterposi_8[5] =
{
     8,
  1424, 200,
  1424, 376
};
Sint16 shooterposi_9[5] =
{
     8,
  1424, 376,
  1424, 200
};
Sint16 shooterposi_0a[5] =
{
     8,
  5744, 296,
  5744, 400
};
Sint16 shooterposi_0b[5] =
{
     8,
  5744, 400,
  5744, 296
};
Sint16 shooterposi_0c[5] =
{
     8,
  7088, 520,
  7088, 600
};
Sint16 shooterposi_0d[5] =
{
     8,
  7088, 600,
  7088, 520
};
Sint16 shooterposi_0e[5] =
{
     8,
  7120, 520,
  7120, 600
};
Sint16 shooterposi_0f[5] =
{
     8,
  7120, 600,
  7120, 520
...
static void shootermove(sprite_status* pActwk) {
  ...
  d0 -= pActwk->xposi.w.h;
  d0 += 16;
  if ((Uint16)d0 >= 32) return;
  d1 = pPlayerwk->yposi.w.h;
  d1 -= pActwk->yposi.w.h;
  d1 += 16;
  if ((Uint16)d1 >= 32) return;
