...
static void z51aline0(Sint16 **ppHscw);
static void z51aline1(Sint16 **ppHscw);
static void z51aline2(Sint16 **ppHscw);
static void z51aline3(Sint16 **ppHscw);
...
static Uint8 z81awrttbl[65] = {
    ...
    0, 6, 6, 6, 6, 6, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4, 4};
static Uint8 z81awrttbl2[49];
...
void enkeichg(void) {
    Sint16 tbl[9] = {3584, 8960, -1, 3584, 8960, -1, 3584, 8960, -1};
    char tbl0[3] = {2, 4, 2};
...
Uint8 playmapnotbl[4] = {127, 127, 21, 91};
...
static void scrbinit(Sint16 sXpos, Sint16 sYpos) {
    ...
    scrb_h_posit.w.h = (Sint16)((Uint16)sXpos >> 2) + sXpos;
...
static void z51aline0(Sint16 **ppHscw) {
    ...
    *ppHscw += 34;
    ...
    for (i = 5; i >= 0; --i) {
        ...
        ldHposwk.l =
            (Uint32)ldHposwk.l >> 16 & 65535 | ldHposwk.l << 16 & -65536;
        ldHposwk.l += lHwk;
        ldHposwk.l =
            (Uint32)ldHposwk.l >> 16 & 65535 | ldHposwk.l << 16 & -65536;
    }
...
void mapwrt_z81a(Uint8 *pMapWk, Sint32 VramBase) {
    ...
    do {
        wD0 = scrb_v_posit.w.h + wD4 & 65520;

        if (enkeino & 1) {
            mapwrt_sub(&z81awrttbl2[1], wD0, wD4, pMapWk, VramBase);
        } else {
