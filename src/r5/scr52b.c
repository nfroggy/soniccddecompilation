...
static void z51bline0(Sint16 **ppHscw);
static void z51bline1(Sint16 **ppHscw);
static void z51bline2(Sint16 **ppHscw);
static void z51bline3(Sint16 **ppHscw);
...
Uint8 playmapnotbl[4] = {127, 127, 21, 25};
