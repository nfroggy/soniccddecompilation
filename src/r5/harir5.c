...
void harir5(sprite_status* pActwk) {
  ...
  if (((Sint16*)pActwk)[28]) {
    ...
    pActwk->xposi.w.h = pRideactwk->xposi.w.h + (Sint16)(char)pActwk->actfree[14];
    pActwk->yposi.w.h = pRideactwk->yposi.w.h + (Sint16)(char)pActwk->actfree[15];
  }

  if ((Uint16)(
      (((Uint16*)pActwk)[29] & 65408) - ((Uint16)(scra_h_posit.w.h - 128) & 65408)
      ) > 640) {
    if (pActwk->cdsts) {
...
static void harir3_ymv1(sprite_status* pActwk) {
  harir3_sub(pActwk);
  pActwk->yposi.w.h = (Sint16)(Uint16)pActwk->actfree[17] + ((Sint16*)pActwk)[27];
}
...
static void harir3_xmv1(sprite_status* pActwk) {
  harir3_sub(pActwk);
  pActwk->xposi.w.h = -(Sint16)(Uint16)pActwk->actfree[17] + ((Sint16*)pActwk)[29];
}
