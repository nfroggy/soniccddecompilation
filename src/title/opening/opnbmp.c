...
static Uint32 hSpr[34];
static Uint32 hGrid[10];
static Uint32 *hBmpBack[1];
static Uint32 hTileBack[1];
static Uint32 hGridBack;
static Uint32 *hBmpMizu[320];
static Uint32 hTileMizu[320];
static Uint32 *hBmpKumo[512];
static Uint32 hTileKumo[512];
static Uint32 hGridMizu;
static Uint32 hGridKumo;
sprite_bmp infoSprtBmp[34] = {{160, 72, {0, 88}, 42, 16, 0, 7, &hSpr[0]},
...
const Uint16 NUM_BMP = 34;
const Uint16 NUM_GRIDBMP = 3;
