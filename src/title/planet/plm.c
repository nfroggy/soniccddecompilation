...
static Sint16 fpat0[8] = {0, 0, -24, 8, -48, -8, -34, 20};
static Sint16 fpat1[8] = {0, 0, -16, -24, -16, 24, -32, 0};
static Sint16 fpat2[12] = {0, 0, -16, -22, -40, -28, -32, 16, -16, 24, -48, -5};
static ini_pats flick_ini_tbl[4] = {
    {4, fpat0}, {4, fpat1}, {6, fpat2}, {6, fpat2}};
static Sint16 spat0[6] = {0, 0, 32, 0, -32, 0};
static ini_pats star_ini_tbl[5] = {
    {3, spat0}, {3, spat0}, {2, spat0}, {1, spat0}, {3, spat0}};
static Sint16 upat0[4] = {0, 0, 16, 48};
static ini_pats ufo_ini_tbl[5] = {
    {1, upat0}, {2, upat0}, {1, upat0}, {2, upat0}, {1, upat0}};
void (*sprinit_tbl[6])(void) = {&flick_set,  &star_set,   &ufo_set,
                                &eggman_set, &metals_set, &tails_set};
Sint16 actset_tbl[12] = {300, 600, 360, 660, 420, 720,
                         480, 780, 540, 840, 600, 900};
...
void flick_set(void) {
    ...
    for (i = 0; i < flick_ini_tbl[lD0.w.l].number; ++i) {
        if (get_actwk(&pActwk) != 0)
            break;

        f_actset(pActwk, pFoffset, iD5, iD6, iD7, i,
                 flick_ini_tbl[lD0.w.l].number - 1);
    }
    actset_wk = 0;
}

void f_actset(sprite_status_lpl *pActwk, ini_pats *pFoffset, Sint16 initx,
              Sint16 inity, Sint16 iReverse, Sint16 iNormal, Sint16 max) {
    int_union lD0;
    Sint16 iD0;
...
void s_actset(sprite_status_lpl *pActwk, ini_pats *pSoffset, Sint16 iD3,
              Sint16 iD5, Sint16 iD6, Sint16 i) {
    int_union lD0;
