...
static char *ScrAMapFileName[3] = {"TITLE\\PLANET\\MAP\\LP.MAP",
...
static Sint16 DATable[39] = {3,  36, 4,  5,  6,  37, 7,  8,  9,  38,
...
static void cd_call(void) { CDPlay(DATable[comdata_m4]); }
