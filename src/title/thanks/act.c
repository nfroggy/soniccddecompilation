...
static void pattern_chg(sprite_status_thanks *pActwk,
                        sprite_patterns_title *pPatTbl);

static void (*act_tbl[31])(sprite_status_thanks *) = {
    &sonic_ctrl, &emie_ctrl,  &metals_ctrl, &flick_ctrl, &pocky_ctrl,
    &ricky_ctrl, &heart_ctrl, &inco_ctrl,   &hato_ctrl,  &sheep_ctrl,
    &pecky_ctrl, &dummy,      &dummy,       &dummy,      &dummy,
...
static void dummy(sprite_status_thanks *pActwk) { pActwk->ACT_NO = 0; }
