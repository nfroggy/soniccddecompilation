...
void scroll(void) {
    ...
    Uint8 z32c_cnttbl[14] = {1, 1, 1, 1, 1, 1, 3, 3, 1, 1, 3, 3, 3, 5};
    Uint16 z32c_kawatbl[3] = {56, 592, 32767};
    Sint16 *pHScrollWork;
    ...
    if (wD3 <= wD1) {
        ...
        zonescrsetsub0(&pHScrollBuff, &pHScrollWork, z32c_kawatbl,
...
void mapwrt_z11a(Uint8 *pMapWk, Sint32 VramBase) {
    ...
    do {
        ...
        mapwrt_sub(&z32cwrttbl[1], wD0, wD4, pMapWk, VramBase);
        wD4 += 16;
    } while ((Sint16)--wD6 >= 0);
}
