...
static tile_changes tbl_drum00 = {
    2, 0, {{10, 0}, {10, 1}}, {drum_no0cg, drum_re0cg}, 436};
static tile_changes tbl_drum01 = {
    2, 0, {{10, 0}, {10, 1}}, {drum_no1cg, drum_re1cg}, 462};
...
void cg_change(void) {
    ...
    if (cg_chg1(&tbl_drum00, 9, &pcgchgtim, &pcgchgcnt, playsubdma, &top) !=
        0) {
    ...
    if (cg_chg1(&tbl_drum01, 5, &pcgchgtim, &pcgchgcnt, playsubdma, &top) !=
        0) {
