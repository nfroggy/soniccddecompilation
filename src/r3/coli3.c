...
Sint16 pcol(sprite_status* pActwk) {
  Sint16 iXwork = pActwk->xposi.w.h,
...
CollitblDataYchk(pActwk, pColliAct, iYposi, iColiNo, iD5);

}

Sint16 CollitblDataYchk(sprite_status* pActwk, sprite_status* pColliAct, Sint16 iYposi, Sint16 iColiNo, Sint16 iD5) {
  Sint16 iColiData;
  Sint16 iYwork;
...
Sint16 eggman_chk(sprite_status* pActwk, sprite_status* pColliAct, char cColiNo) {
