...
void scroll(void) {
    ...
    Uint8 z31d_cnttbl[15] = {1, 3, 1, 1, 1, 1, 1, 1, 3, 1, 3, 3, 3, 3, 1};
    Uint8 z31d_cnttbl1[3] = {6, 1, 0};
    Uint16 z31d_kawatbl[3] = {8, 32767, 32767};
    Sint16 *pHScrollWork;
    ...
    *pHScrollWork++ = lD0.w.l;
    ...
    if (wD3 <= wD1) {
        ...
        zonescrsetsub0(&pHScrollBuff, &pHScrollWork, z31d_kawatbl,
...
void mapwrt_z11a(Uint8 *pMapWk, Sint32 VramBase) {
    ...
    do {
        ...
        mapwrt_sub(&z31dwrttbl[1], wD0, wD4, pMapWk, VramBase);
        wD4 += 16;
    } while ((Sint16)--wD6 >= 0);
}
