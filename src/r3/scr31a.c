...
void scroll(void) {
  ...
  Uint8 z31a_cnttbl[15] = {
    1, 3, 1, 1, 1, 1, 1, 1,
    3, 1, 3, 3, 3, 3, 1
  };
  Uint16 z31a_kawatbl[3] = {
    56, 592, 32767
  };
  Uint16 lposi_tbl[6] = {
...
lD2.l = (Sint16)(scra_h_posit.w.h - scrb_h_posit.w.h);
  ...
  if (wD3 <= wD1) {
    ...
    zonescrsetsub0(&pHScrollBuff, (Uint16**)&pHScrollWork, z31a_kawatbl, awasintbl, wD1, (Uint16*)&lD2.w.l, &wD4);
