...
void scroll(void) {
  ...
  Uint8 z32d_cnttbl[16] = {
    1, 3, 1, 1, 1, 3, 1, 3, 1, 1, 1, 3, 3, 1, 1, 1
  };
  Uint8 z32d_cnttbl1[3] = {
    6, 1, 0
  };
  Uint16 z32d_kawatbl[3] = {
    8, 32767, 32767
  };
  Sint16* pHScrollWork;
...
lD2.l = (Sint16)(scra_h_posit.w.h - scrb_h_posit.w.h);
  ...
  if (wD3 <= wD1) {
    ...
    zonescrsetsub0(&pHScrollBuff, (Uint16**)&pHScrollWork, z32d_kawatbl, awasintbl, wD1, (Uint16*)&lD2.w.l, &wD4);
