...
void scroll(void) {
  Sint32 LineSpdTbl[10] = {
    32768, 24576, 16384,
    12288,  8192,  8192,
    12288, 16384, 24576,
    32768
  };
  Uint8 z32b_cnttbl[10] = {
    1, 1, 1, 1, 1, 5, 1, 1, 3, 1
  };
  Uint8 z32b_cnttbl0[3] = {
    3, 1, 1
  };
  Uint8 z32b_cnttbl1[6] = {
    5, 1, 1, 3, 1, 1
  };
  Uint16 z32b_kawatbl[3] = {
    64, 528, 32767
  };
  Sint16* pHScrollWork;
...
lD2.l = (Sint16)(scra_h_posit.w.h - scrb_h_posit.w.h);
  ...
  if (wD3 <= wD1) {
    ...
    zonescrsetsub0(&pHScrollBuff, (Uint16**)&pHScrollWork, z32b_kawatbl, awasintbl, wD1, (Uint16*)&lD2.w.l, &wD4);
