...
void harir3(sprite_status* hariwk) {
  ...
  if ((ride_no = ((Uint16*)hariwk)[28]) != 0) {
    hariwk->xposi.w.h = (Sint16)hariwk->actfree[14] + actwk[ride_no].xposi.w.h;

    hariwk->yposi.w.h = (Sint16)hariwk->actfree[15] + actwk[ride_no].yposi.w.h;
  }

  cal_x = (((Uint16*)hariwk)[29] & 65408) - ((Uint16)(scra_h_posit.w.h - 128) & 65408);

  if (cal_x > 640) tr3_fout(hariwk);
}

void harir3_init(sprite_status* hariwk) {
  Uint8 harir3sztbl[12] = {
     16,   8,   0,
     18,  12, 131,
     12,  16, 130,
     12,  16, 130
...
void frdr3(sprite_status* floorwk) {
  ...
  actionsub(floorwk);
  cal_x = (((Uint16*)floorwk)[27] & 65408) - ((Uint16)(scra_h_posit.w.h - 128) & 65408);
...
void frdr3_move(sprite_status* floorwk) {
  ...
  do {
    ...
    if (floorwk->actfree[16] == 0) {
      ...
      ((Sint16*)floorwk)[30] = frdr3_mvtbl0[floorwk->actfree[17] * 2 + 1];
...
void trapdr3(sprite_status* floorwk) {
  ...
  actionsub(floorwk);
  cal_x = (((Uint16*)floorwk)[29] & 65408) - ((Uint16)(scra_h_posit.w.h - 128) & 65408);
...
void trapdr3_kind(sprite_status* floorwk) {
  if (!(floorwk->userflag.b.h & 4)) {
    ...
    floorwk->yposi.w.h = ((Sint16*)floorwk)[27] + (Sint16)floorwk->actfree[17];
...
void trapdr3_updown(sprite_status* floorwk) {
  ...
  cal_x = actwk[0].xposi.w.h - (floorwk->xposi.w.h - (Sint16)floorwk->sprhsize);
  if (cal_x >= 0) {
    if (cal_x < 80) return;
  ...
  do {
    if (floorwk->actfree[14] == 0) {
      ...
      if (floorwk->userflag.b.h == 1) {
        ...
        ((Sint16*)floorwk)[29] = for3_rmvtbl0[floorwk->actfree[15] * 2 + 1];
        ...
        ((Sint16*)floorwk)[29] = for3_lmvtbl0[floorwk->actfree[15] * 2 + 1];
  ...
  do {
    ...
    if (floorwk->actfree[14] == 0) {
      ...
      if (floorwk->userflag.b.h == 3) {
        ...
        ((Sint16*)floorwk)[29] = for3_umvtbl0[floorwk->actfree[15] * 2 + 1];

        ((Sint16*)floorwk)[28] = for3_umvtbl1[floorwk->actfree[15]];

      } else {
        floorwk->actfree[14] = for3_dmvtbl0[floorwk->actfree[15] * 2];
        ((Sint16*)floorwk)[29] = for3_dmvtbl0[floorwk->actfree[15] * 2 + 1];
  ...
  do {
    if (floorwk->actfree[14] == 0) {
      ...
      if (floorwk->userflag.b.h == 5) {
        ...
        ((Sint16*)floorwk)[29] = for3_8btbl0[floorwk->actfree[15] * 2 + 1];
        ...
        ((Sint16*)floorwk)[29] = for3_16btbl0[floorwk->actfree[15] * 2 + 1];

        ((Sint16*)floorwk)[28] = for3_16btbl1[floorwk->actfree[15]];

      } else {
        floorwk->actfree[14] = for3_28btbl0[floorwk->actfree[15] * 2];
        ((Sint16*)floorwk)[29] = for3_28btbl0[floorwk->actfree[15] * 2 + 1];
...
void getdair3_move(sprite_status* floorwk) {
  if (floorwk->userflag.b.h < 0) {
    ...
    floorwk->xposi.w.h = ((Sint16*)floorwk)[29] + (Sint16)floorwk->actfree[17];
...
tbl[corewk->r_no0 / 2](corewk);
  actionsub(corewk);
  cal_x = (((Uint16*)corewk)[29] & 65408) - ((Uint16)(scra_h_posit.w.h - 128) & 65408);
...
void drumr3(sprite_status* drumwk) {
  ...
  cal_x = (((Uint16*)drumwk)[27] & 65408) - ((Uint16)(scra_h_posit.w.h - 128) & 65408);
