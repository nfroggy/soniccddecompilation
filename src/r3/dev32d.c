...
static tile_changes tbl_drumb00 = {
    2, 0, {{10, 0}, {10, 1}}, {drum_no0cg, drum_re0cg}, 417};
static tile_changes tbl_drumb01 = {
    2, 0, {{10, 0}, {10, 1}}, {drum_no1cg, drum_re1cg}, 443};
...
void cg_change(void) {
    ...
    if (cg_chg1(&tbl_drumb00, 9, &pcgchgtim, &pcgchgcnt, playsubdma, &top) !=
        0) {
    ...
    if (cg_chg1(&tbl_drumb01, 7, &pcgchgtim, &pcgchgcnt, playsubdma, &top) !=
        0) {
