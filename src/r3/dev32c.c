...
static tile_changes tbl_drumg00 = {
    2, 0, {{10, 0}, {10, 1}}, {drum_no0cg, drum_re0cg}, 438};
static tile_changes tbl_drumg01 = {
    2, 0, {{10, 0}, {10, 1}}, {drum_no1cg, drum_re1cg}, 464};
...
void cg_change(void) {
    ...
    if (cg_chg1(&tbl_drumg00, 9, &pcgchgtim, &pcgchgcnt, playsubdma, &top) !=
        0) {
    ...
    if (cg_chg1(&tbl_drumg01, 7, &pcgchgtim, &pcgchgcnt, playsubdma, &top) !=
        0) {
