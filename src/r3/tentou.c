...
void (*tentou_tbl[6])(sprite_status *) = {
    &ten_a_init, &ten_a_fall, &ten_a_wait, &ten_a_lr, &ten_a_up, &ten_a_gake};
void (*tentou1_tbl[5])(sprite_status *) = {
    &ten_b_init, &ten_b_fall, &ten_b_wait, &ten_b_blink, &ten_b_die};
Uint8 pchg0_0[5] = {3, 0, 1, 2, 255};
Uint8 *pchg0[1] = {pchg0_0};
sprite_pattern ten_b_tentou0 = {1, {{-24, -24, 0, SPRITE_TENTOU_BASE}}};
sprite_pattern ten_b_tentou1 = {1, {{-24, -24, 0, SPRITE_TENTOU_BASE + 1}}};
sprite_pattern ten_b_tentou2 = {1, {{-24, -24, 0, SPRITE_TENTOU_BASE + 2}}};
sprite_pattern *pat_ten_b_tentou[3] = {&ten_b_tentou0, &ten_b_tentou1,
                                       &ten_b_tentou2};
sprite_pattern e_tentou0 = {1, {{-24, -24, 0, SPRITE_TENTOU_BASE + 3}}};
sprite_pattern e_tentou1 = {1, {{-24, -24, 0, SPRITE_TENTOU_BASE + 4}}};
sprite_pattern e_tentou2 = {1, {{-24, -24, 0, SPRITE_TENTOU_BASE + 5}}};
sprite_pattern *pat_e_tentou[3] = {&e_tentou0, &e_tentou1, &e_tentou2};
Uint8 pchg1_0[4] = {1, 0, 1, 255};
Uint8 *pchg1[1] = {pchg1_0};
sprite_pattern bomten_b_0 = {1, {{-8, -8, 0, SPRITE_TENTOU_BASE + 6}}};
sprite_pattern bomten_b_1 = {1, {{-8, -8, 0, SPRITE_TENTOU_BASE + 7}}};
sprite_pattern *tentou_bomten_b_pat[2] = {&bomten_b_0, &bomten_b_1};
