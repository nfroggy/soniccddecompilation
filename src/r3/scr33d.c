...
void scroll(void) {
  Sint32 LineSpdTbl[12] = {
    49152, 32768, 24576,
    16384, 12288,  8192,
     8192, 12288, 16384,
    24576, 32768, 49152
  };
  Uint8 z33d_cnttbl[12] = {
    1, 3, 3, 1, 1, 3, 1, 3, 3, 3, 3, 3
  };
  Uint8 z33d_cnttbl1[3] = {
    5, 1, 0
  };
  Uint16 z33d_kawatbl[3] = {
    24, 32767, 32767
  };
  Sint16* pHScrollWork;
...
lD2.l = (Sint16)(scra_h_posit.w.h - scrb_h_posit.w.h);
  ...
  if (wD3 <= wD1) {
    ...
    zonescrsetsub0(&pHScrollBuff, (Uint16**)&pHScrollWork, z33d_kawatbl, awasintbl, wD1, (Uint16*)&lD2.w.l, &wD4);
