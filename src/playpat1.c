...
static sprite_pattern patbc = {
  1,
  { { -16, -20, 16, 206 } }
};
static sprite_pattern patbd = {
  1,
  { { -16, -20, 16, 207 } }
};
static sprite_pattern patbe = {
  1,
  { { -16, -20, 16, 204 } }
};
static sprite_pattern patbf = {
  1,
  { { -16, -20, 16, 205 } }
};
static sprite_pattern patc0 = {
  1,
  { { -16, -20, 16, 206 } }
};
static sprite_pattern patc1 = {
  1,
  { { -16, -20, 16, 207 } }
};
static sprite_pattern patc2 = {
  1,
  { { -20, -20, 16, 208 } }
};
static sprite_pattern patc3 = {
  1,
  { { -20, -20, 16, 209 } }
};
static sprite_pattern patc4 = {
  1,
  { { -20, -20, 16, 210 } }
};
static sprite_pattern patc5 = {
  1,
  { { -20, -20, 16, 211 } }
};
