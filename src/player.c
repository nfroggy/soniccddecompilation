...
extern void sub_sync(Sint16 ReqNo); extern void playsp(void); extern Sint16 pcol(sprite_status* pActwk); extern void da_set(void); extern void plairset(void); extern void soundset(Sint16 ReqNo); extern Sint16 playdieset(sprite_status* pActwk);

extern sprite_pattern* sncpat[];
extern Uint8 mapwka[8][64];
extern Uint8* playchg[60];
extern Uint8 plchg00[8], plchg01[8], plchg49[8], plchg53[8], plchg03[8], plchg02[8], plchg54[8], plchg35[6], plchg04[8], plchg39[7], plchg33[6], plchg34[6];
...
void play00jump(void) {
  if (watercoliflag == 0 && actwk[0].mstno.b.h != 21 && actwk[0].yspeed.w >= 0) {
    actwk[0].mstno.b.h = 0;
  }
  chk11();
  backto_chk();
...
index = (actwk[0].yposi.w.h >> 1 & 896) + ((Sint16)actwk[0].xposi.b.b1 & 127);
  ...
  if ((Uint8)actwk[0].direc.b.h <= 128) return;
  actwk[0].actflg &= 191;
}
