...
static Uint8 tobita1chg0[16] = { 2, 0, 1, 0, 2, 0, 1, 0, 3, 4, 3, 5, 3, 4, 3, 255 };
...
Sint16 colli_pl_sikake_d(sprite_status* pActwk, sprite_status* pPlayerwk, Sint16 collinum) {
  if (editmode.b.h == 0)
  {
...
Sint16 colli_pl_sikake(sprite_status* pActwk, sprite_status* pPlayerwk, Sint16 collnum) {
  Sint16 xe;
  Sint16 xe_w;
  Sint16 xp;
  Sint16 xp_w;
