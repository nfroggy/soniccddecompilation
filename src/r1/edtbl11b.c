...
extern sprite_pattern *shibukipat[];
...
edit_data edit_tbl = {58,
                      0,
                      {{45, 1, pat_et, 1087},
                       {46, 3, pat_movie, 1027},
                       {38, 1, hari12pat, 800},
                       {40, 1, tobita1_pat, 897},
                       {40, 1, tobita1_pat, 897, 1, 1, 0, 0},
                       {13, 1, futapat, 808},
                       {9, 1, k_daipat, 820},
                       {27, 1, iwapat, 838},
                       ...
                       {10, 1, spring45pat, 1168, 8, 0, 0, 0},
                       {10, 1, spring45pat, 1168, 8, 2, 0, 0},
                       {10, 1, spring45pat, 1168, 8, 1, 0, 0},
                       {10, 1, spring45pat, 1168, 8, 3, 0, 0},
                       {10, 1, springpat, 9504, 2, 0, 0, 0},
                       {10, 1, springpat, 9504, 2, 2, 0, 0},
                       {10, 1, spring90pat, 9504, 6, 0, 0, 0},
                       {10, 1, spring90pat, 9504, 6, 1, 0, 0},
                       {10, 1, spring45pat, 9360, 10, 0, 0, 0},
                       {10, 1, spring45pat, 9360, 10, 2, 0, 0},
                       {10, 1, spring45pat, 9360, 10, 1, 0, 0},
                       {10, 1, spring45pat, 9360, 10, 3, 0, 0},
                       {36, 3, pat_friend0, 858},
                       {36, 3, pat_friend1, 858, 1, 0, 0, 3},
                       {61, 4, e_ka_pat, 9110},
                       {62, 4, e_chou_pat, 9279},
                       {63, 4, ari_pat, 9197},
                       {25, 4, itempat, 1448},
                       ...
                       {4, 1, shibukipat, 954},
                       {14, 1, mizukipat, 926},
                       {32, 3, patbase_kuzure_a, 17598, 16, 1, 0, 0},
                       {32, 3, patbase_kuzure_a, 17598},
                       {32, 3, patbase_kuzure_a, 17598, 17, 1, 0, 1},
                       {32, 3, patbase_kuzure_a, 17598, 1, 0, 0, 1},
                       {32, 3, patbase_kuzure_b, 17598, 128, 0, 0, 0},
                       {32, 3, patbase_kuzure_b, 17598, 129, 0, 0, 1},
                       {32, 3, patbase_kuzure_b, 17598, 131, 0, 0, 3},
                       {32, 3, patbase_kuzure_b, 17598, 132, 0, 0, 4},
                       {32, 3, patbase_kuzure_b, 17598, 130, 0, 0, 2},
                       {32, 3, patbase_kuzure_b, 17598, 133, 0, 0, 5},
                       {25, 4, itempat, 1448, 8, 0, 0, 10},
                       {25, 4, itempat, 1448, 9, 0, 0, 12},
                       {19, 3, markerpat, 1152, 1, 0, 0, 0},
                       {50, 3, edapat, 987},
                       {50, 3, edapat, 987, 1, 0, 0, 1},
                       {51, 3, kagepat, 971},
