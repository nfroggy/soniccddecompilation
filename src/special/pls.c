...
void clear_chk(void) {
  if (ufoleft != 0) return;
  actwk[0].exeno = 8;
  if (actwk[39].actno != 0) actwk[39].actflg |= 1;
  if (actwk[47].actno != 0) actwk[47].actflg |= 1;
}
...
void evt05(sprite_status_sp* plwk) {
  ...
  for ( ; cal_ring > 0; --cal_ring) actwk[24 - cal_ring].actno = 13;
}
...
Sint16 k_search(sprite_status_sp** new_actwk) {
  ...
  for (i = 8; i < 16; ++i)
    if ((*new_actwk = &actwk[i])->actno == 0) return 0;
  return -1;
}
...
void sibuki1(sprite_status_sp* sibukiwk) {
  if (--((Sint16*)sibukiwk)[36] != 0) return;
  if (actwk[0].scno_ce != 3) { sibukiwk->actflg |= 1; return; }
  patinit(sibukiwk, 1);
  sibukiwk->exeno = 2;
}

void sibuki2(sprite_status_sp* sibukiwk) {
  if (actwk[0].scno_ce != 3) sibukiwk->actflg |= 1;
  else if (sibukiwk->patno == 0) tdecflg = 2;
}

void sibuki_clr(void) {
  if (actwk[2].actno != 0) actwk[2].actflg |= 1;
}
...
void kemuri1(sprite_status_sp* kemuriwk) {
  if (--((Sint16*)kemuriwk)[36] == 0) kemuriwk->actflg |= 1;
...
void t_stone1(sprite_status_sp* stonewk) {
  if (--((Sint16*)stonewk)[36] == 0) ++stonewk->exeno;
}
...
void t_stone2(sprite_status_sp* stonewk) {
  ...
  ++stonewk->exeno;
  actwk[6].actflg |= 1; actwk[7].actflg |= 1;
...
void t_stone3(sprite_status_sp* stonewk) {
  if (--((Sint16*)stonewk)[36] == 0) gmclrflg = 1;
}
