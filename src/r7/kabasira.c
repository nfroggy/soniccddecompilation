...
static Uint32 kabasira_area(sprite_status* pActwk, sprite_status* pPlayerwk, Sint16* pX, Sint16* pY);

static Uint8 pchg_00[18] = { 15, 4, 5, 6, 7, 8, 9, 10, 11, 10, 11, 0, 1, 2, 3, 4, 5, 255 };
...
static Uint8 pchg_04[18] = { 7, 4, 5, 6, 7, 8, 9, 10, 11, 10, 11, 0, 1, 2, 3, 4, 5, 255 };
