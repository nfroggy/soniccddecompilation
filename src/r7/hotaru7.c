...
static Uint32 area(sprite_status* pActwk, sprite_status* pPlayerwk, Uint16 Ypos, Uint16 Ylen, Uint16 Xpos, Uint16 Xlen);
...
Uint32 area(sprite_status* pActwk, sprite_status* pPlayerwk, Uint16 Ypos, Uint16 Ylen, Uint16 Xpos, Uint16 Xlen) {
  Uint16 len;
