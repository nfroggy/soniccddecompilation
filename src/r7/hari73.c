...
sprite_pattern *hari73_pat[2] = {&hari73_pat0, &hari73_pat1};

void hari73(sprite_status *pActwk) {
    void (*hari73_acttbl[3])(sprite_status *) = {&hari73_init, &hari73_move,
                                                 &hari73_tobi};
...
static void msnc_hit(sprite_status *pActwk) {
    ...
    Sint16 spd_tbl[16] = {576, -512, 6, 16, 544, -512, 0,  18,
                          512, -512, 6, 20, 480, -512, 10, 16};
