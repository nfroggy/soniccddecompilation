...
PALETTEENTRY advacolor[64] = {
    ...
    {128, 224, 160, 1}, {96, 192, 0, 1},    {32, 96, 0, 1},
    {0, 64, 0, 1},      {0, 0, 0, 1},       {128, 0, 0, 1},
    {0, 32, 0, 1},      {224, 160, 0, 1},   {0, 0, 96, 1},
    {32, 0, 0, 1},      {192, 192, 64, 1},  {96, 64, 32, 1},
    {64, 96, 0, 1},     {224, 160, 224, 1}, {224, 0, 0, 1},
    {0, 0, 32, 1},      {0, 0, 0, 1},       {0, 32, 32, 1},
    {32, 32, 0, 1},     {64, 64, 0, 1},     {0, 64, 224, 1},
    {224, 224, 160, 1}, {224, 224, 224, 1}, {96, 0, 160, 1},
    {128, 128, 128, 1}, {224, 128, 0, 1},   {64, 0, 128, 1},
    {32, 0, 96, 1},     {0, 0, 64, 1},      {224, 224, 96, 1},
    {224, 224, 0, 1}};
PALETTEENTRY zone82colora[48] = {
    ...
    {224, 0, 0, 1},     {0, 0, 32, 1},      {128, 224, 160, 1},
    {96, 192, 0, 1},    {32, 96, 0, 1},     {0, 64, 0, 1},
    {0, 0, 0, 1},       {128, 0, 0, 1},     {0, 32, 0, 1},
    {224, 160, 0, 1},   {0, 0, 96, 1},      {32, 0, 0, 1},
    {192, 192, 64, 1},  {96, 64, 32, 1},    {64, 96, 0, 1},
    {224, 160, 224, 1}, {224, 0, 0, 1},     {0, 0, 32, 1},
    {0, 0, 0, 1},       {0, 32, 32, 1},     {32, 32, 0, 1},
    {64, 64, 0, 1},     {0, 64, 224, 1},    {224, 224, 160, 1},
    {224, 224, 224, 1}, {96, 0, 160, 1},    {128, 128, 128, 1},
    {224, 128, 0, 1},   {64, 0, 128, 1},    {32, 0, 96, 1},
    {0, 0, 64, 1},      {224, 224, 96, 1},  {224, 224, 0, 1}};
palette_part colortbl[6] = {{advacolor, 0, 64},       {advacolor, 0, 64},
                            {advacolor, 0, 64},       {advacolor, 0, 16},
                            {&advacolor[16], 16, 48}, {zone82colora, 16, 48}};
