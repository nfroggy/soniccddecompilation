...
static void z61aline(Sint16 **ppHscw);
...
void z61aline(Sint16 **ppHscw) {
    char z81ascrtbl[9] = {5, 3, 2, 2, 1, 1, 1, 1, 1};
    Sint32 i, j;
    Sint16 sXwk, radwk, sinwk, coswk, hwk;
    Sint32 lXwk;
    ...
    *ppHscw += 26;
    ...
    for (i = 8; i >= 0; --i) {
        ...
        sinset(radwk, &sinwk, &coswk);
        hwk = -(sXwk + (Sint16)((Uint16)((256 - coswk) * lXwk) >> 8));
