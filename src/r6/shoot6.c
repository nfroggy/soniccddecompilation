...
extern sprite_pattern* ringpat[9]; static Sint16 stackpointer; extern sprite_pattern* bariapat[13];
...
static Sint16 gas_coli_colig(sprite_status* gaswk, sprite_status* plwk) {
  ...
  cal_posi = plwk->xposi.w.h - gaswk->xposi.w.h + (cal_size = (Sint16)plwk->sprhs + 16);

  if (cal_posi < 0 || cal_posi >= cal_size * 2) return 0;
  cal_posi = plwk->yposi.w.h - gaswk->yposi.w.h + (cal_size = (Sint16)plwk->sprvsize + 32);
...
static Uint16 shooterposi_1[16] = {
...
static Uint16 shooterposi_5[31] = {
...
static Uint16 shooterposi_8[13] = {
  24, 0, 0, 0, 8, 0, 0, 8, 65280, 0,
  56, 65280, 0
};
static Uint16 shooterposi_9[13] = {
  24, 0, 0, 0, 8, 0, 0, 8, 256, 0,
  56, 256, 0
};
static Uint16 shooterposi_0a[13] = {
  24, 0, 0, 0, 8, 0, 0, 8, 65280, 0,
  56, 65280, 0
};
static Uint16 shooterposi_0b[7] = { 12, 0, 0, 0, 96, 0, 0 };
static Uint16 shooterposi_0c[13] = {
  24, 0, 0, 0, 432, 0, 0, 432, 256, 0,
  992, 256, 0
};
static Uint16 shooterposi_0d[16] = {
...
static void shootermove3(sprite_status* shootwk) {
  ...
  if ((char)--shootwk->actfree[4] < 0) {
    actwk[0].xposi.w.h = ((Sint16*)shootwk)[29]
                       + shootwk->xposi.w.h;
    actwk[0].yposi.w.h = ((Sint16*)shootwk)[30]
                       + shootwk->yposi.w.h;
