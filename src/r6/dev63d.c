...
static Sint32 r01cg[4] = {33, 34, 35, 36};
static Sint32 r02cg[4] = {37, 38, 39, 40};
static Sint32 r03cg[4] = {41, 42, 43, 44};
static Sint32 r04cg[4] = {45, 46, 47, 48};
static tile_changes tbl_thund = {
    3, 0, {{4, 0}, {4, 1}, {4, 2}}, {t1cg, t2cg, t3cg}, 380};
static tile_changes tbl_null = {
    3, 0, {{4, 0}, {4, 1}, {4, 2}}, {nullcg, nullcg, nullcg}, 380};
static tile_changes tbl_sp = {2, 0, {{2, 0}, {2, 1}}, {sp1cg, sp2cg}, 376};
static tile_changes tbl_light = {
    4, 0, {{4, 0}, {9, 1}, {4, 2}, {15, 3}}, {r01cg, r02cg, r03cg, r04cg}, 372};
...
void cg_change(void) {
    ...
    if (bossflag & 64) {
        ...
        bossflag |= 128;
        if (cg_chg1(&tbl_null, 7, &pcgchgtim, &pcgchgcnt, playsubdma, &top) !=
            0) {
