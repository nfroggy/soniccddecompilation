...
static void main_init(sprite_status* blockwk) {
  ...
  ((Uint16*)blockwk)[23] = blockwk - actwk;
...
static void main_move(sprite_status* blockwk) {
  ...
  ((char**)blockwk)[12] = tbl0[blockwk->userflag.b.h][((Uint16*)blockwk)[27] / 2];

  if ((((Uint16*)blockwk)[27] += 2) >= 8)
    ((Uint16*)blockwk)[27] = 0;
...
static void sub(sprite_status* blockwk) {
  ...
  parent_wk = &actwk[((Uint16*)blockwk)[23]];
...
static void sub_go(sprite_status* blockwk) {
  ...
  blockwk->r_no0 += 2;
  ((Sint16*)blockwk)[26] = 63;
  ((Sint32*)blockwk)[15] = ((Sint32*)blockwk)[16] = 0;

  speed_tbl = ((char**)blockwk)[12] - 1;
  switch (speed_data = *speed_tbl) {
    case 0:
      ((Sint32*)blockwk)[16] = -32768;
      break;
    case 1:
      ((Sint32*)blockwk)[15] = 32768;
      break;
    case 2:
      ((Sint32*)blockwk)[16] = 32768;
      break;
...
if (actwk[((Uint16*)blockwk)[23]].userflag.b.h == 2) {
    if (((Sint32*)blockwk)[16] >= 0)
      ((Sint16*)blockwk)[28] = blockwk->yspeed.w = 1;
    else
      ((Sint16*)blockwk)[28] = blockwk->yspeed.w = -1;
  }
  sub_go1(blockwk);
...
static void sub_go1(sprite_status* blockwk) {
  blockwk->xposi.l += ((Sint32*)blockwk)[15];
  blockwk->yposi.l += ((Sint32*)blockwk)[16];
  if (--((Sint16*)blockwk)[26] < 0) blockwk->r_no0 += 2;
}
...
static void sub_stop0(sprite_status* blockwk) {
  ...
  if (parent_wk->userflag.b.h != 2)
    ((Sint16*)blockwk)[26] = 30;
  else
    ((Sint16*)blockwk)[26] = 0;
}

static void sub_stop01(sprite_status* blockwk) {
  if (--((Sint16*)blockwk)[26] >= 0) return;
  blockwk->r_no0 += 2;
  if (set_slave(blockwk) == 0) return;
  blockwk->r_no0 += 2;
  actwk[((Uint16*)blockwk)[23]].actfree[10] = 255;
}
...
static void sub_back(sprite_status* blockwk) {
  blockwk->r_no0 += 2;
  ((Sint16*)blockwk)[26] = 63;
  blockwk->yspeed.w = -((Sint16*)blockwk)[28];
}
...
static void sub_stop11(sprite_status* blockwk) {
  ...
  if (--((Sint16*)blockwk)[26] >= 0) return;
  parent_wk = &actwk[((Uint16*)blockwk)[29]];
...
static Uint8 set_slave(sprite_status* blockwk) {
  ...
  ((Uint16*)new_actwk)[23] = ((Uint16*)blockwk)[23];

new_actwk->userflag.b.h = -1;
  ((Uint16*)new_actwk)[29] = blockwk - actwk;
