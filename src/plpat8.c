...
static sprite_pattern pat18 = {1, {{-8, -12, 0, 111}}};
static sprite_pattern pat19 = {1, {{-8, -12, 0, 112}}};
static sprite_pattern pat1a = {1, {{-24, -20, 0, 0}}};
static sprite_pattern pat1b = {1, {{-20, -20, 0, 0}}};
static sprite_pattern pat1c = {1, {{-24, -20, 0, 0}}};
static sprite_pattern pat1d = {1, {{-20, -20, 0, 0}}};
static sprite_pattern pat1e = {1, {{-24, -20, 0, 0}}};
static sprite_pattern pat1f = {1, {{-24, -20, 0, 0}}};
static sprite_pattern pat20 = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat21 = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat22 = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat23 = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat24 = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat25 = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat26 = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat27 = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat28 = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat29 = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat2a = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat2b = {1, {{-16, -16, 0, 0}}};
static sprite_pattern pat2c = {1, {{-16, -16, 0, 0}}};
...
static sprite_pattern pat6f = {1, {{-8, -12, 0, 111}}};
static sprite_pattern pat70 = {1, {{-8, -12, 0, 112}}};
static sprite_pattern pat71 = {1, {{-8, -12, 0, 113}}};
static sprite_pattern pat72 = {1, {{-8, -12, 0, 114}}};
static sprite_pattern pat73 = {1, {{-8, -12, 0, 115}}};
static sprite_pattern pat74 = {1, {{-8, -12, 0, 116}}};
static sprite_pattern pat75 = {1, {{-8, -12, 0, 117}}};
static sprite_pattern pat76 = {1, {{-8, -12, 0, 118}}};
static sprite_pattern pat77 = {1, {{-8, -12, 0, 119}}};
static sprite_pattern pat78 = {1, {{-8, -12, 0, 120}}};
static sprite_pattern pat79 = {1, {{-16, -12, 0, 121}}};
static sprite_pattern pat7a = {1, {{-8, -12, 0, 122}}};
static sprite_pattern pat7b = {1, {{-8, -12, 0, 123}}};
static sprite_pattern pat7c = {1, {{-8, -6, 0, 124}}};
static sprite_pattern pat7d = {1, {{-8, -6, 0, 125}}};
static sprite_pattern pat7e = {1, {{-8, -6, 0, 126}}};
...
static sprite_pattern pata6 = {1, {{-20, -20, 0, 113}}};
static sprite_pattern pata7 = {1, {{-20, -16, 0, 167}}};
static sprite_pattern pata8 = {1, {{-20, -16, 0, 168}}};
static sprite_pattern pata9 = {1, {{-20, -16, 0, 169}}};
static sprite_pattern pataa = {1, {{-20, -16, 0, 170}}};
static sprite_pattern patab = {1, {{-16, -12, 0, 171}}};
static sprite_pattern patac = {1, {{-16, -12, 0, 172}}};
static sprite_pattern patad = {1, {{-16, -20, 0, 0}}};
static sprite_pattern patae = {1, {{-16, -20, 0, 0}}};
static sprite_pattern pataf = {1, {{-16, -20, 0, 0}}};
static sprite_pattern patb0 = {1, {{-16, -20, 0, 0}}};
static sprite_pattern patb1 = {1, {{-16, -20, 0, 0}}};
static sprite_pattern patb2 = {1, {{-16, -20, 0, 0}}};
static sprite_pattern patb3 = {1, {{-16, -20, 0, 0}}};
static sprite_pattern patb4 = {1, {{-16, -20, 0, 0}}};
static sprite_pattern patb5 = {1, {{-16, -20, 0, 181}}};
static sprite_pattern patb6 = {1, {{-16, -20, 0, 182}}};
static sprite_pattern patb7 = {1, {{-16, -20, 0, 183}}};
static sprite_pattern patb8 = {1, {{-12, -20, 0, 184}}};
static sprite_pattern patb9 = {1, {{-16, -20, 0, 0}}};
static sprite_pattern patba = {1, {{-16, -20, 0, 0}}};
static sprite_pattern patbb = {1, {{-16, -20, 8, 1}}};
sprite_pattern *sncpat[188] = {
    &pat00, &pat01, &pat02, &pat03, &pat04, &pat05, &pat06, &pat07, &pat08,
    &pat09, &pat0a, &pat0b, &pat0c, &pat0d, &pat0e, &pat0f, &pat10, &pat11,
    &pat12, &pat13, &pat14, &pat15, &pat16, &pat17, &pat18, &pat19, &pat1a,
    &pat1b, &pat1c, &pat1d, &pat1e, &pat1f, &pat20, &pat21, &pat22, &pat23,
    &pat24, &pat25, &pat26, &pat27, &pat28, &pat29, &pat2a, &pat2b, &pat2c,
    &pat2d, &pat2e, &pat2f, &pat30, &pat31, &pat32, &pat33, &pat34, &pat35,
    &pat36, &pat37, &pat38, &pat39, &pat3a, &pat3b, &pat3c, &pat3d, &pat3e,
    &pat3f, &pat40, &pat41, &pat42, &pat43, &pat44, &pat45, &pat46, &pat47,
    &pat48, &pat49, &pat4a, &pat4b, &pat4c, &pat4d, &pat4e, &pat4f, &pat50,
    &pat51, &pat52, &pat53, &pat54, &pat55, &pat56, &pat57, &pat58, &pat59,
    &pat5a, &pat5b, &pat5c, &pat5d, &pat5e, &pat5f, &pat60, &pat61, &pat62,
    &pat63, &pat64, &pat65, &pat66, &pat67, &pat68, &pat69, &pat6a, &pat6b,
    &pat6c, &pat6d, &pat6e, &pat6f, &pat70, &pat71, &pat72, &pat73, &pat74,
    &pat75, &pat76, &pat77, &pat78, &pat79, &pat7a, &pat7b, &pat7c, &pat7d,
    &pat7e, &pat7f, &pat80, &pat81, &pat82, &pat83, &pat84, &pat85, &pat86,
    &pat87, &pat88, &pat89, &pat8a, &pat8b, &pat8c, &pat8d, &pat8e, &pat8f,
    &pat90, &pat91, &pat92, &pat93, &pat94, &pat95, &pat96, &pat97, &pat98,
    &pat99, &pat9a, &pat9b, &pat9c, &pat9d, &pat9e, &pat9f, &pata0, &pata1,
    &pata2, &pata3, &pata4, &pata5, &pata6, &pata7, &pata8, &pata9, &pataa,
    &patab, &patac, &patad, &patae, &pataf, &patb0, &patb1, &patb2, &patb3,
    &patb4, &patb5, &patb6, &patb7, &patb8, &patb9, &patba, &patbb};
