...
void zone11chk(void) { /* Line 112, Address: 0x1017cf0*/
  if (time_flag != 1) { /* Line 113, Address: 0x1017cf8*/
    ...
    if ((Uint16)actwk[0].xposi.w.h >= 7190) { /* Line 117, Address: 0x1017d20*/
      if ((Uint16)actwk[0].xposi.w.h < 8646) { /* Line 118, Address: 0x1017d3c*/
        scra_vline = 136; /* Line 119, Address: 0x1017d58*/
      }
    }

    scralim_n_down = 1808; /* Line 123, Address: 0x1017d64*/
    if ((Uint16)scra_h_posit.w.h >= 2112) { /* Line 124, Address: 0x1017d70*/

if (pltime_f != 0 && (Uint16)scralim_left < 2080) { /* Line 128, Address: 0x1017d8c*/

        scralim_left = scralim_n_left = 2080; /* Line 130, Address: 0x1017dbc*/

      }
      if ((Uint16)scra_h_posit.w.h >= 3584) { /* Line 133, Address: 0x1017dd8*/
